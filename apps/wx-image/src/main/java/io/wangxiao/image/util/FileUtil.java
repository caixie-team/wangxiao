...
public class FileUtil {
    ...
    //尾不带/
    public static final String rootpath = formatUrlEnd(propertyUtil.getProperty("file.root"));
    ...
    public static String[] getSavePathByRequest(HttpServletRequest request) {
        ...
        //物理savePath
        savePath.append(rootpath).append("/").append(pathfix)
                .append("/").append(base)
                .append("/").append(param);
        //url
    ...
    public static String formatUrlEnd(String url) {
        if (url.endsWith("/")) {
