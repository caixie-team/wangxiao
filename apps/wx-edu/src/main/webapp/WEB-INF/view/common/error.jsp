...
<%@page import="com.business.platform.core.util.ObjectUtils"%>
...
<title>系统异常</title>
	<style type="text/css">
		* {margin: 0;padding: 0;}
		...
		.e-4-wrap {background: #3b3b3b url(${ctximg}/static/edu/images/err-404.jpg) no-repeat 0 0;margin: 5% auto 0;width: 640px;overflow: hidden;}
