...
<c:choose>
        ...
        <div class="d-tips-4">
            ...
            <ul class="l-r-w-Inpt">
				...
				<span class="inpCb">
					...
					<tt for="forget" class="vam c-999 ml5">自动登录</tt>
				</span>
				<span class="ml10">
				...
				<span class="ml10">
					<a href="${ctx}/register" target="_blank" title="还没账号，去注册！" class="c-master">
                        <u>还没账号，去注册！</u></a>
				</span>
                </li>
                <li class="mt30">
                ...
                <li class="mt10 tac">
                	<p class="hLh30 line2"><span class="vam c-666">可以使用以下方式快速登录</span></p>
                	<div class="mt10">
                		<a href="javascript:oauthLogin('QQ')" class="vam" title="QQ账号登录"><img width="28" height="28" alt="QQ账号登录" class="vam" src="${ctx}/static/edu/images/open/qq.png"></a>
                		<a href="javascript:oauthLogin('SINA')" class="vam ml10" title="微博账号登录"><img width="28" height="28" alt="微博账号登录" class="vam" src="${ctx}/static/edu/images/open/sina.png"></a>
                	</div>
                </li>
            </ul>
        </div>
    ...
    <c:when test="${dialog.index==8}">
		<div class='d-tips-5'>
			<div class="tac pa" id="loadingDiv" style="left: 50%;top: 50%;margin: -20px 0 0 -50px;width: 100px;height: 40px;z-index: 0;">
			...
			<div class="" style='width: 612px; height: 440px;z-index: 0;' id="smallPlayer">${dialog.conent}</div>
		</div>
	</c:when>
	...
	<c:when test="${dialog.index==19}"> <!-- 	解绑弹框 -->
		<div class='d-tips-2'>
			<ul class='l-r-w-Inpt'>
				<li>
					<p class="tac fsize14 f-fM c-666" style="padding:0;">解除绑定后将不再使用<b>${dialog.conent}</b>登录${websitemap.web.company}</p>
					<p id="bundingName" class="tac fsize14 f-fM c-666 mt10 mb20" style="padding:0;"></p>
					<span class="tac fsize14 f-fM c-666 mt10 mb20" style="margin-left: 50px;">密码：</span>
					<span><input id='excludeBundingPwd' type='password' class='lTxt' value='' style="width: 165px;" maxlength="8"></span>
				</li>
			</ul>
			<div class='tac mt30'>
				<a href='${dialog.url}' title='确定' class='order-submit'>确定</a><a
