										...
										<dd>
											<div class="cc-wrap">
												<a href="/mobile/course/info/${courseRecommend.id}" title="" class="cc-list-1">
													<img xSrc="<%=staticImageServer %>${courseRecommend.logo}" src="${ctximg}/static/mobile/img/sprite.gif" alt="">
										...
										<dd>
											<div class="cc-wrap">
												<a href="/mobile/course/info/${courseHot.id}" title="" class="cc-list-1 cc-list-2">
													<img xSrc="<%=staticImageServer %>${courseHot.logo}" src="${ctximg}/static/mobile/img/sprite.gif" alt="">
													<section class="cc-l-title">
