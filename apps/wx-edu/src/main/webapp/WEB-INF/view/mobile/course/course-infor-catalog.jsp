						...
						<!-- 课程目录 -->
							...
							<div class="courese-menu-tree">
								...
								<dl>
									...
									<dd>
										<ol class="c-m-t-level-2">
											<c:forEach items="${courseKpoint.childKpoints}" var="subKpoint">
											<li class="kpointLi" id="${subKpoint.id}li" onclick="getPlayerBox(${subKpoint.id},${subKpoint.isfree})"><c:if test="${ subKpoint.isfree==1}"><img src="/static/mobile/img/mianf.jpg"  width="68" height="12" class="freeImg"></c:if><tt class="cmt-time">${subKpoint.courseMinutes }分${subKpoint.courseSeconds }秒</tt><a href="javascript:void(0)" title=""><em>&nbsp;</em><span>${subKpoint.name }</span></a></li>
											</c:forEach>
										</ol>
									</dd>
								</dl>
