...
<script src="${ctximg}/static/mobile/js/login/register.js" type="text/javascript"></script>
	...
	<section class="lr-main">
		<div class="lr-ul">
			...
			<ul>
				...
				<li class="vCode" id="code">
					...
					<span class="vCodeImg"><img src="${ctx}/ran/adminrandom" height="45" width="100" border="0" alt="" onclick="this.src='${ctx}/ran/adminrandom?random='+Math.random();"></span>
		...
		<div class="clearfix ulr-link">
			<span class="fr"><a href="/mobile/index" title="">首页</a>|<a href="/mobile/login" title="">已有账号，去登录</a></span>
			<span class="fl"><input type="checkbox" name="abcAgreement" value="" checked="checked" class="xy-ok"><a href="javascript:void(0)" title="" style="margin-left: 0;vertical-align:middle;">同意用户协议</a></span>
		</div>
		<!-- /login register -->
