...
function activationCard(){
	...
	$.ajax({
		type : "POST",
		dataType : "json",
		url : "${ctx}/course/activationcard/1",
		data : {"cardCode.type":1,"cardCode.cardCode":cardCode, "cardCode.cardCodePassword":cardCodePwd},
		async : false,
						...
						<section class="c-sort">
							...
							<div class="lfb-wrap">
								<ol class="u-account-set">
									...
									<li>
										<label class="u-a-inp" style="margin: 10px 0 0 0;"><input type="password" id="cardCodePwd" value="" name="cardCode.cardCodePassword" placeholder="输入课程卡密码" required="required"></label>
									</li>
								</ol>
