            ...
            <div  class="am-tabs">
                ...
                <div class="am-tabs-bd">
                    <div id="tab1" class="am-tab-panel am-fade am-active am-in">
                        <form action="${ctx}/admin/website/updateImages" class="am-form" data-am-validator>
                                ...
                                <div class="am-u-sm-8 am-u-md-10">
                                    <select data-am-selected="{btnSize: 'sm'}" required style="display: none;" id="doc-vld-keyWord" name="websiteImages.keyWord">
                                        ...
                                        <c:forEach items="${websiteImageMangeList}" var="imageType">
                                            <option value="${imageType.image_key}"
                                                <c:if test="${imageType.image_key eq websiteImages.keyWord}">selected="selected"</c:if>>${imageType.type}
                                            </option>
                                        </c:forEach>
                                    </select>
                                </div>
                            ...
                            <div class="am-g am-margin-top am-form-group">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <input type="text" id="doc-vld-imagesTitle" class="am-input-sm" required placeholder="请填写广告图标题" name="websiteImages.title" value="${websiteImages.title}">
                                </div>
                            ...
                            <div class="am-g am-margin-top am-form-group">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <input type="text" id="imagesUrl" class="am-input-sm" required placeholder="请填写图片地址或上传图片" name="websiteImages.imagesUrl" value="${websiteImages.imagesUrl}">
                                </div>
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <c:if test="${not empty websiteImages.imagesUrl}">
                                        <img id="imgpic" src="<%=staticImageServer%>${websiteImages.imagesUrl}" alt="" width="360px" height="200px" class="am-img-thumbnail am-radius">
                                    </c:if>
                                    <c:if test="${empty websiteImages.imagesUrl}">
                            ...
                            <div class="am-g am-margin-top am-form-group">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <input type="text" id="doc-vld-linkAddress" class="am-input-sm" name="websiteImages.linkAddress" value="${websiteImages.linkAddress}">
                                </div>
                                <div class="am-u-sm-12 am-u-md-6"></div>
                            </div>
                            <div class="am-g am-margin-top am-form-group">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <input type="text" class="am-input-sm" name="websiteImages.color" value="${websiteImages.color}" id="imageColor">
                                </div>
                                <div class="am-u-sm-12 am-u-md-6"></div>
                            </div>
                            <div class="am-g am-margin-top am-form-group">
                                ...
                                <div class="am-u-sm-8 am-u-md-4">
                                    <input type="text" id="doc-vld-seriesNumber" onkeyup="this.value=this.value.replace(/\D/g,'')" class="am-input-sm" placeholder="请输入序列号" required value="${websiteImages.seriesNumber}" name="websiteImages.seriesNumber" id="seriesNumber" value="0">
                                </div>
