...
<script type="text/javascript"
	src="<%=imagesPath %>/kindeditor/kindeditor-all.js?v=${v}"></script>
...
<body>
	<div class="am-cf">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">微信管理</strong> / <small>修改文本素材</small>
		</div>
	</div>
	<hr />
	<!-- /tab4 begin -->
		...
		<div class="am-tabs">
			...
			<div class="am-tabs-bd">
				<div id="tab1" class="am-tab-panel am-fade am-active am-in">
					<form action="${ctx}/admin/weixin/update" class="am-form"
						method="post" id="updateForm">
						<input type="hidden" name="weixinReply.id"
						...
						<div class="am-g am-margin-top am-form-group am-form-error">
							...
							<div class="am-u-sm-4 am-u-md-2">
								<input required data-foolish-msg="关键词不能为空" type="text"
									value="${weixinReply.keyword}" name="weixinReply.keyword"
									id="keyword" class="{required:true}" />
							</div>
						...
						<div class="am-g am-margin-top am-form-group am-form-error">
							<div class="am-u-sm-4 am-u-md-2 am-text-right" for="mobile">
								内容</div>
							<div class="am-u-sm-4 am-u-md-4">
								<textarea required data-foolish-msg="内容不能为空" rows="4"
									maxlength="600" cols="40" name="weixinReply.content"
									id="content">${weixinReply.content}</textarea>
							</div>
							<div class="am-hide-sm-only am-u-md-6">
						...
						<div class="am-u-sm-12 am-u-end am-text-center">
							...
							<button class="am-btn am-btn-danger" title="提 交" type="submit">提
								交</button>
							<a class="am-btn am-btn-danger" title="返 回"
