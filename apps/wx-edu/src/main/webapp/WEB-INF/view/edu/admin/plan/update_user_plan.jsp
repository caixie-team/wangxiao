...
<body>
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">计划管理</strong> / <small>修改计划</small></div>
</div>
<hr>
<form action="/admin/plan/updatePlan" method="post" class="am-form" data-am-validator id="addPlan">
	<input type="hidden" name="plan.type" id="planType" value="0">
	<input id="emIds" type="hidden" name="queryPlan.examIds" value="${queryPlan.examIds}"/>
	<input id="ucIds" type="hidden" name="queryPlan.userIds" value="${queryPlan.userIds}" />
