					...
					<tbody>
						...
						<tr>
							<td align="center" colspan="2">
								<!-- <a class="am-btn am-btn-danger" title="提 交" href="javascript:addTeacherFormSubmit()">提 交</a> --> <a class="am-btn am-btn-danger" title="返 回" href="javascript:history.go(-1);">返 回</a>
							</td>
						</tr>
					</tbody>
				</table>
