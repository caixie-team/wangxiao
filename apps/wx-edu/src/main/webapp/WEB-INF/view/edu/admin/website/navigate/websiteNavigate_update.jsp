...
<body>
<div class="am-cf">
  <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">导航管理</strong> / <small>导航修改</small></div>
</div>
<hr>
<div class="mt20">
	<div  class="am-tabs">
		...
		<div class="am-tabs-bd">
			<div id="tab1" class="am-tab-panel am-fade am-active am-in am-scrollable-vertical">
				<form class="am-form" data-am-validator action="${ctx}/admin/website/updateNavigate" id="updateNavigateForm" method="post">
				<input type="hidden" name="websiteNavigate.id" value="${websiteNavigate.id}"/>
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input type="text" value="${websiteNavigate.name}" class="am-input-sm" required placeholder="请填写导航名称" name="websiteNavigate.name" id="navigateName">
						</div>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input type="text" value="${websiteNavigate.url}" class="am-input-sm" required placeholder="请填写跳转链接" name="websiteNavigate.url" id="navigateUrl">
						</div>
						<div class="am-hide-sm-only am-u-md-6"></div>
					</div>
					...
					<div class="am-g am-margin-top" am-form-group>
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" value="${websiteNavigate.orderNum}" name="websiteNavigate.orderNum" required id="orderNum" class="am-input-sm" value="0" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
						</div>
...
<script type="text/javascript">
 $(function(){
	 $("#type").val("${websiteNavigate.type}");
	 $("#newPage").val("${websiteNavigate.newPage}");
 })
</script>
</body>
</html>