...
<hr>
<form action="${ctx}/admin/cou/openerlist" name="searchForm" id="searchForm" method="post" class="am-form">
						...
						<tr>
							<td>
								<label class="am-radio">
									<input type="radio" name="courseId" value="${cou.id}#${cou.name}" data-am-ucheck/>
									${cou.id}
								</label>
							</td>
							<td>${cou.name }</td>
...
<div class="mt20 am-padding admin-content-list">
	<div class="am-tab-panel am-fade am-active am-in">
		<div class="am-g am-margin-top am-u-sm-12 am-text-left">
			<a class="am-btn am-btn-danger" title="确定" href="javascript:chooseCourse()">确定</a>
			<a class="am-btn am-btn-danger" title="取消" href="javascript:closeWin()">取消</a>
		</div>
		<div class="mt20 clear"></div>
	</div>
</div>
