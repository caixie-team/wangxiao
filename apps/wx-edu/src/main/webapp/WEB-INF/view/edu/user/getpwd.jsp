...
<div id="retrieve_pwd"  class="retrieve_password">
	<h3>重置密码<span>（重置后请重新登录）</span></h3>
	<div class="con_left contents">
		<p class="fa_p1">
			<label>新密码：</label><input  name="password" maxlength="30" class="text_input" type="password" />
		</p>
		<p class="fa_p1">
			<label>确认密码：</label><input  name="confirmPwd" maxlength="30" class="text_input" type="password"/>
		</p>
        <p class="chooseitem padl80 colorred" class="e-mail_back"  ></p>
		<div><p class="fa_p1 padl80"><a class="go-live-btn" href="javascript:void(0)"  onclick="updatepwd('${code}');"><span>提交</span></a></div>
	</div>
	...
	<div id="getmail" class="e-mail_back" style="display: none;">
		...
		<div class="send_password">
			<div class="send_pass_txt">
				...
				<div class="cont">
					<p class="fg_p1">密码重置成功,请重新用新密码登录</p>
					<p class="mt20"><a class="commBtn04" href="/login" >点击这里登陆</a></p></div>
			</div>
		</div>
	</div>
<!--stop e-mail_back-->
