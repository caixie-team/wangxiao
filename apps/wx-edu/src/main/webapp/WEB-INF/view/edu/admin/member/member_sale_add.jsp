...
<body >
	<div class="am-cf">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">会员商品管理</strong> / <small>新建会员商品</small>
		</div>
	</div>
	<hr/>
	<div class="mt20">
		<div class="am-tabs">
			...
			<div class="am-tabs-bd">
				<div class="am-tab-panel am-fade am-active am-in">
					<form action="${ctx}/admin/membersale/add" method="post" id="addForm" class="am-form">
						<div class="am-g am-margin-top">
							<div class="am-u-sm-4 am-u-md-2 am-text-right"><i class="am-text-danger">*</i>&nbsp;名称 </div>
							<div class="am-u-sm-8 am-u-md-4">
								<input type="text" name="memberSale.name" id="name" class="am-input-sm" />
							</div>
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								<input type="text" name="memberSale.price" id="price"  class="am-input-sm" />
							</div>
							<div class="am-hide-sm-only am-u-md-6 am-text-danger">&nbsp;</div>
						</div>
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								<input type="text" name="memberSale.days" id="days" class="am-input-sm" />
							</div>
							<div class="am-hide-sm-only am-u-md-6 am-text-danger">&nbsp;</div>
						</div>
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								<input type="text" id="sort" name="memberSale.sort" value="0" class="am-input-sm" onkeyup="this.value=this.value.replace(/\D/g,'')"/><i class="am-text-danger">倒序</i>
							</div>
							<div class="am-hide-sm-only am-u-md-6 am-text-danger">&nbsp;</div>
						</div>
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								<textarea rows="5" cols="70" name="memberSale.description" id="description" ></textarea>
							</div>
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								...
								<button class="am-btn am-btn-success" title="返 回" type="button" onclick="history.go(-1);">返 回</button>
							</div>
							<div class="am-hide-sm-only am-u-md-6 am-text-danger">&nbsp;</div>
						</div>
					</form>
