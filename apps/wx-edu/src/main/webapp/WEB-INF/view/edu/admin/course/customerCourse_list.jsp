...
<script type="text/javascript">
	...
	function del(courseId){
		...
		window.location.href="${ctx}/admin/customerCourse/deleteCourse?customerCourseId="+courseId;
	}
						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="commonTab01">
							...
							<tbody id="tabS_02" align="center">
								...
								正常
											...
											<td>${course.remark}</td>
											<td class="c_666 czBtn" align="center"><a class="ml10 btn smallbtn btn-y" title="删除" href="javascript:del(${course.id})">删除</a> <c:if test="${course.status==0}">
