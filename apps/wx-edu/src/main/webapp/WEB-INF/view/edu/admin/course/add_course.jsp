...
<body>
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">课程管理</strong> / <small>新建课程</small></div>
</div>
<hr>
<form action="${ctx}/admin/cou/addCourse" method="post" id="courseForm" class="am-form" data-am-validator>
	...
	<input name="course.logo" id="courseLogo" type="hidden" />
		...
		<div data-am-tabs="" class="am-tabs">
			<div class="am-g am-margin-top am-form-group">
				...
				<div class="am-u-sm-8 am-u-md-8">
					<select name="course.sellType" id="sellType" onchange="sellTypeChange()" data-am-selected="{btnWidth: '40%', btnSize: 'sm', btnStyle: 'secondary'}">
			...
			<div class="am-tabs-bd">
				<div id="tab1" class="am-tab-panel am-fade am-active am-in">
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="name" class="am-input-sm" required placeholder="请填写课程名称" name="course.name">
						</div>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<textarea id="title" name="course.title" required></textarea>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="hidden" name="course.context" id="hidContext"/>
							<script id="context" type="text/plain"></script>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="number" id="minutes" class="am-input-sm" onkeyup="this.value=this.value.replace(/\D/g,'')" value="0" required placeholder="请填写学时" name="course.minutes">
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top am-form-group">
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="number" id="totalLessionnum" class="am-input-sm" onkeyup="this.value=this.value.replace(/\D/g,'')" value="0" required placeholder="请填写总课时数" name="course.totalLessionnum">
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="hidden" value="OUTTER" name="course.companySellType" id="companySellTypeVal" />
							<input id="companySellType" type="checkbox" checked data-size="sm" data-am-switch data-off-color="danger">
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="number" id="order" class="am-input-sm" onkeyup="this.value=this.value.replace(/\D/g,'')" value="0" required placeholder="请填写排序" name="course.order">
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top ">
				...
				<div id="tab2" class="am-tab-panel am-fade am-in showLive">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<label class="am-radio-inline">
								<input type="radio" value="0" name="course.isRestrict" onchange="restrictChange(0)" data-am-ucheck checked> 否
							</label>
							<label class="am-radio-inline">
								<input type="radio" value="1" name="course.isRestrict" onchange="restrictChange(1)" data-am-ucheck> 是
							</label>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top undis" id="restrictNumDiv">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">
							直播限定人数
						</div>
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" class="am-input-sm" name="course.restrictNum" id="restrictNum" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="liveBeginTime" class="form-datetime-lang am-form-field" name="course.liveBeginTime" readonly/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="liveEndTime" class="form-datetime-lang am-form-field" name="course.liveEndTime" data-am-datepicker="{format: 'yyyy-mm-dd'}" readonly/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="freeurl" class="am-input-sm" name="course.freeurl" />
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="teacherVideoUrl" class="am-input-sm" name="course.teacherVideoUrl" />
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="videoPassword" class="am-input-sm" name="course.videoPassword" />
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top" id="reserve">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<label class="am-radio-inline">
								<input type="radio" value="0" name="course.isReserve" data-am-ucheck checked /> 否
							</label>
							<label class="am-radio-inline">
								<input type="radio" value="1" name="course.isReserve" data-am-ucheck/>是
							</label>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
				...
				<div id="tab3" class="am-tab-panel am-fade am-in">
					<c:if test="${salemap.sale.verifyMember=='ON'}">
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-6">
								<c:forEach items="${memberTypes }" var="memberType" varStatus="count">
									<div class="am-u-sm-6 am-u-md-6 am-u-end">
										<label class="am-checkbox">
											<input type="checkbox" name="courseMember" data-am-ucheck value="${memberType.id }" />${memberType.title }
										</label>
									</div>
								</c:forEach>
							</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<label class="am-radio-inline">
								<input type="radio" value="0" name="course.isPay" onchange="payChange(0)" data-am-ucheck checked /> 免费
							</label>
							<label class="am-radio-inline">
								<input type="radio" value="1" name="course.isPay" onchange="payChange(1)" data-am-ucheck/> 收费
							</label>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top price undis">
						<div class="am-u-sm-4 am-u-md-2 am-text-right">
							<font class="am-text-danger">*</font> 课程原价格
						</div>
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" name="course.sourceprice" required class="am-input-sm" id="sourceprice" />
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top price undis">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" name="course.currentprice" class="am-input-sm" id="currentprice"/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top ">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<select name="course.losetype" id="losetype" data-am-selected="{btnWidth: '40%', btnSize: 'sm', btnStyle: 'secondary'}">
								<option value="0" selected>到期时间</option>
					...
					<div class="am-g am-margin-top loseAbsTimeShow">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" id="loseAbsTime" class="form-datetime-lang am-form-field" name="course.loseAbsTime" readonly/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top loseTimeShow undis">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="number" id="loseTime" class="am-input-sm" name="course.loseTime" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top ">
				...
				<div id="tab4" class="am-tab-panel am-fade am-in">
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="number" id="pageBuycount" class="am-input-sm" name="course.pageBuycount" required onkeyup="this.value=this.value.replace(/\D/g,'')" value="0" placeholder="请输入销售数量"/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="number" id="pageViewcount" class="am-input-sm" name="course.pageViewcount" required onkeyup="this.value=this.value.replace(/\D/g,'')" value="0" placeholder="请输入浏览数量"/>
						</div>
						<div class="am-hide-sm-only am-u-md-4"></div>
					</div>
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-8">
							...
							<%--<a class="am-btn am-btn-danger" title="提 交" href="javascript:addCourseFormSubmit()">提 交</a>--%>
