...
<head>
	...
	<script type="text/javascript">
		$(function () {
			$("#status").val(${planOld.status});
			$("#isRepeat").val(${planOld.isRepeat});
		});
	</script>
</head>
<body>
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">计划管理</strong> / <small>修改岗位计划</small></div>
</div>
<hr>
<form action="${ctx}/admin/plan/updatePlan" method="post" class="am-form" data-am-validator id="addPlan">
			...
			<div class="am-tabs-bd">
				<div id="tab1" class="am-tab-panel am-fade am-active am-in">
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" name="plan.beginTime" id="beginTime" readonly="readonly" class="form-datetime-lang am-form-field" required value="<fmt:formatDate value="${planOld.beginTime }" pattern="yyyy-MM-dd HH:mm:ss" />">
						</div>
						<div class="am-hide-sm-only am-u-md-6"><font class="am-text-danger">*</font>&nbsp;必填</div>
					</div>
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" name="plan.endTime" id="endTime" readonly="readonly" class="form-datetime-lang am-form-field" required value="<fmt:formatDate value="${planOld.endTime }" pattern="yyyy-MM-dd HH:mm:ss" />">
						</div>
						<div class="am-hide-sm-only am-u-md-6"><font class="am-text-danger">*</font>&nbsp;必填</div>
					</div>
					<div class="am-g am-margin-top am-form-group">
										...
										<td>
											<div class="am-u-sm-6">
												<label class="am-radio">
													<input type="radio" data-am-ucheck="" value="0" checked name="plan.isRepeat" class="am-ucheck-radio">
													不可重复
												</label>
												<label class="am-radio">
													<input type="radio" data-am-ucheck="" value="1" name="plan.isRepeat" class="am-ucheck-radio">
													可以重复
												</label>
											</div>
										</td>
