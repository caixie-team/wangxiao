...
<body>
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">推荐课程分类管理</strong> / <small>推荐课程分类添加</small></div>
</div>
<hr/>
<div class="mt20">
	<div  class="am-tabs">
		...
		<div class="am-tabs-bd">
			<div id="tab1" class="am-tab-panel am-fade am-active am-in">
				<form class="am-form" data-am-validator action="${ctx}/admin/website/addCourse" method="post" id="addWebsiteCourseForm">
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input type="text" name="websiteCourse.name" id="websiteCourseName" class="am-input-sm" />
						</div>
					</div>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text"  name="websiteCourse.link" id="oppWebsiteCourseLink"  id="link" class="am-input-sm"/>
						</div>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" name="websiteCourse.courseNum" id="courseNum" required value="0" onkeyup="this.value=this.value.replace(/\D/g,'')" class="am-input-sm"/>
						</div>
						<div class="am-u-sm-12 am-u-md-6"></div>
					</div>
