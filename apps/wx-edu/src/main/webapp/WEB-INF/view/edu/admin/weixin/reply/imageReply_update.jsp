...
<body>
	<div class="am-cf">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">微信管理</strong> / <small>更新图文素材</small></div>
	</div>
	<hr/>
	<div class="mt20">
		<div class="am-tabs">
					...
					<form class="am-form" action="${ctx}/admin/weixin/update" method="post" id="updateForm">
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-8">
								<span>
									<c:if test="${not empty weixinReply.imageUrl}">
										<img src="<%=staticImageServer%>${weixinReply.imageUrl}" alt="" width="360px" height="200px" id="weixinpic" />
									</c:if>
									<c:if test="${empty weixinReply.imageUrl}">
										<img src="${ctx}/static/edu/images/NotAvailable.png" alt="" width="360px" height="200px" id="weixinpic" />
									</c:if>
