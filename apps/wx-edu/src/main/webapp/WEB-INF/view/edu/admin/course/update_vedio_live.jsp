			...
			<div class="mt20">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						...
						<tr>
							<td align="center" colspan="2"><a class="am-btn am-btn-danger" title="提 交" href="javascript:addLiveFormSubmit()">提 交</a> <a class="am-btn am-btn-danger" title="返 回" href="javascript:history.go(-1);">返 回</a></td>
						</tr>
					</tbody>
				</table>
			</div>
