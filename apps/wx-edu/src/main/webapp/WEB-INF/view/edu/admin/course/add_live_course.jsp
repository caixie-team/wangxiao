...
<body >
		...
		<input id="tcIds" type="hidden" name="course.teacherIds" value="" />
            ...
            <input type="hidden" name="course.sellType" value="LIVE"/>
            <input type="hidden" name="course.classTypeId"  id="class_type_id"  value="0" />   
			<div class="page_head">
				<h4>
					<em class="icon14 i_01"></em> &nbsp; <span>直播管理</span> &gt; <span>新建直播</span>
				</h4>
			</div>
			<!-- /tab4 begin -->
			<div class="mt20">
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
                      ...
                      <tr class="showLive">
                        ...
                        <tr class="showLive">
                            <td width="20%" align="center"><font color="red">*</font> &nbsp;学员直播编码</td>
                            <td><input id="freeurl" type="text" name="course.freeurl" class="" value="" /></td>
                        </tr>

                       <tr class="showLive">
                            <td width="20%" align="center"><font color="red">*</font> &nbsp;教师直播编码</td>
                            <td><input id="teacherVideoUrl" type="text" name="course.teacherVideoUrl" class="" value="" /></td>
                        </tr>
<%--                        <tr class="showLive">
                            <td width="20%" align="center"><font color="red">*</font> &nbsp;教师直播密码</td>
                            <td><input id="videoPassword" type="text" name="course.videoPassword" class="" value="" /></td>
                        </tr>--%>
						...
						<tr>
							...
							<td width="80%"><input type="text" name="course.sourceprice" value="0" /></td>
						</tr>
...
<!-- 				<tr>
						<td align="center"><font color="red">*</font> &nbsp;是否对外公开</td>
							<td>
								<select name="course.companySellType" id="companySellType">
									<option value="">---请选择---</option>
									<option value="OUTTER">外部公开</option>
									<option value="INNER">圈子专属</option>
								</select>
							</td>
					</tr>
 -->                        <%--
