...
<script type="text/javascript">
	...
	function addCourseHandoutFormSubmit() {
...
<body>
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">讲义管理</strong> / <small>新建讲义</small></div>
</div>
<hr>
<div class="mt20">
	<div class="am-tabs">
		...
		<div class="am-tabs-bd">
			<div id="tab1" class="am-tab-panel am-fade am-active am-in">
				<form action="${ctx}/admin/cou/addCourseHandout" method="post" id="addCourseHandout" class="am-form" data-am-validator>
					<input name="handout.courseId" type="hidden" value="${courseId}" />
					<div class="am-g am-margin-top am-form-group">
						<label for="name" class="am-u-sm-4 am-u-md-2 am-text-right">
							<i class="am-text-danger">*</i>讲义名称
						</label>
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" class="am-input-sm" required placeholder="请填写讲义名称" name="handout.name" id="name">
						</div>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<input type="text" class="am-input-sm" required placeholder="可直接输入地址" name="handout.path" id="urlStr">
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-6">
							<a class="am-btn am-btn-danger" title="提 交" href="javascript:addCourseHandoutFormSubmit()">提 交</a>
