		...
		<div class="container">
			...
			<article class="mt30" id="order_init">
				...
				<div>
					...
					<dl id="shopingcart" class="c-order-list of shopcar-list">
						<!-- 购物车信息 -->
					</dl>
				</div>
				<!--商品清单结束-->
				...
				<div class="mt30">
					...
					<div class="c-pay-method c-p-m"> 
						...
						<div class="tar mt40"> <a class="order-btn" href="javascript:order()">提交订单</a> </div> 
					</div>
				</div>
				<!--结算信息 end-->
			</article>
					...
					<section class="mt20 mr20 mb20 ml20">
						<div class="orderSuccess pr ml20"  >
							<ol>
								...
								<li class="tac"></li>
								<li class="mt20"><span class="c-333 fsize14">您现在可以：<a id="repaylink" class="c-333 mr10" title="查看订单信息" href="${ctx}/front/repay/"><u>返回修改支付方式</u></a> | <a class="c-4e ml10 mr10" title="进入学习中心" href="${ctx }/uc/home"><u>进入学习中心</u></a> | <a class="c-4e ml10" title="返回首页" href="${ctx }/"><u>返回首页</u></a></span></li>
							</ol>
