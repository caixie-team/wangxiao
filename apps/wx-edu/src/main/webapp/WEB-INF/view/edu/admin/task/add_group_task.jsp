...
<div class="mt20">
    <div class="commonWrap">
        <form action="/admin/task/updateTask" method="post" id="addTask">
            <input type="hidden" name="task.type" id="taskType" value="1">
            <input id="emIds" type="hidden" name="task.examIds" value="${taskOld.userIds}"/>
            <input type="hidden" name="courseIds" id="courseIdHidden"/>
            <input id="emNames" type="hidden" name="task.examNames" value=""/>
            <input name="task.groupIds" type="hidden" id="groupIds">
