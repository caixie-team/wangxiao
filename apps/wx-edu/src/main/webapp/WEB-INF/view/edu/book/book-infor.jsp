				...
				<article class="fl w650" style="width: 770px;">
					...
					<div  id="booklYDId" class="publicClass" style="display: none;">
						...
						<section id="comm_tips_section_id">
							...
							<div class="comment-box">
								...
								<!-- 图书答凝分页 -->
								<%-- <section style="display: none;" id="newStaticShowpage">
								<div class="pagination pagination-large tac">
			                  	<jsp:include page="/static/ucenter268/common/staticShowpage.jsp" />
								</div>
								</section> --%>
								<!-- 图书答凝分页 -->
							</div>
					...
					<div id="bookComment" class="publicClass" style="display: none;">
						...
						<section class="pl20 pr20">
							...
							<!-- 图书评价分页 -->
							<%-- <section style="display: none;" id="newStaticShowpage2">
							<div class="pagination pagination-large tac">
		                  	<jsp:include page="/static/ucenter268/common/staticShowpage2.jsp" />
							</div>
							</section> --%>
							<!-- 图书评价分页 -->
						</section>
