	...
	<div class="page_head">
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" class="commonTab01" >				
					...
					<tbody id="tabS_02" align="center">
						<c:if test="${arrangeRecordGroudUser.size()>0}">
							<c:forEach  items="${arrangeRecordGroudUser}" var="record" >
						  <tr>
							 <td><span>${record.id}</span></td>
							 <td><span><a href="${ctx}/admin/arrange/exam/papers/${record.userId}">${record.nickname}</a></span></td>
						     <td><span>${record.arrangename}</span></td>
						...
						<c:if test="${arrangeRecordGroudUser.size()==0||arrangeRecordGroudUser==null}">
							<tr>
