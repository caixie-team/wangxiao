								...
								<div class="c-c-i-wrap">
									...
									<section class="ml10 mr10">
										...
										<div class="clearfix mt5">
											<span class="fr"><em class="icon16 c-p-num">&nbsp;</em><font class="c-master fsize12" id="span${customerCourse.id}">${customerCourse.joinNum}人想学</font></span>
										...
										<div class="clearfix mt10">
											...
											<span class="fl" title="${customerCourse.userExpandDto.showname}">
                                                ...
                                                <c:if test="${not empty customerCourse.userExpandDto.showname}">
                                                    ${fn:substring(customerCourse.userExpandDto.showname,0,16)}
                                                </c:if>
                                                </font>
