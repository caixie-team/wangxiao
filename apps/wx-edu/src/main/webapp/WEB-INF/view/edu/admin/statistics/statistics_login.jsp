...
<script type="text/javascript" language="javascript">
	$(function() {
		...
		initLineEcharts("container","学员活跃走势图","学员",dateTime,studentNum);
	});
...
<body>
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">统计管理</strong> / <small>学员活跃度统计图</small></div>
</div>
<hr>
<div class="mt20">
	<div  class="am-tabs">
		<div class="am-tabs-bd">
			<div id="tab1" class="am-tab-panel am-fade am-active am-in">
				<form action="${ctx}/admin/statistics/login" class="am-form" data-am-validator>
		...
		<form class="am-form">
			<table class="am-table am-table-striped am-table-hover table-main">
				...
				<tr>
					...
					<th class="table-title am-text-center" width="50%">活跃人数</th>
				</tr>
				</thead>
				<tbody>
