...
<body >
		<form action="${ctx}/admin/live/add" method="post" id="addVedioLiveForm">
			<div class="page_head">
				<h4>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="vedioLive.title" required />
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td>
								<input type="text" name="vedioLive.code" class="required" />
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td>
								<input type="text" name="vedioLive.teacher" class="required" />
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td>
								<input readonly="readonly" type="text" id="liveTime" name="vedioLive.liveTime" class="required" />
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td>
								<input type="text" name="vedioLive.joinNum" class="required number" />
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td>
								<textarea id="content" rows="6" cols="80" name="vedioLive.content" required></textarea>
							</td>
						</tr>
						<tr>
							<td align="center">
							...
							<td>
								<input readonly="readonly" type="text" id="endTime" name="vedioLive.endTime" class="required" />
							</td>
						</tr>
						<tr>
							<td align="center" colspan="2">
								<a class="am-btn am-btn-danger" title="提 交" href="javascript:addLiveFormSubmit()">提 交</a>
