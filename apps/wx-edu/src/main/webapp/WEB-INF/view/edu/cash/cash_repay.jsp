        ...
        <article class="mt30" id="order_init">
            ...
            <div class="mt30">
                ...
                <div class="c-pay-method">
                    <div class="of">
                        <!--网上支付 -网银 支付开始 -->
                        <%-- <header class="c-pay-title">网上银行</header>
                        ...
                        <!--网上支付 -网银 支付结束 -->
                        <!--网上支付 -第三方开始 -->
                        <header class="c-pay-title">第三方支付平台</header>
                        <div class="buyB_payPlat">
                            <ul class="clearfix">
                                <%--<c:if test="${keywordmap.keyword.yee=='ON' }">
                                    <li><label>
                ...
                <div class="c-pay-method c-p-m">
                    <div>
                        <div class="fr tar p-mt15">
                            <p class="fsize24 c-333 mt20 hLh30">应付订单金额：<span id="payprice" class="c-master fsize36 f-fG">￥${cashOrder.amount}</span></p>
                        </div>
                        <div class="clear"></div>
                    </div>
            ...
            <div class="order-table pb20"  >
                <section class="mt20 mr20 mb20 ml20">
                    <div class="orderSuccess pr ml20"  >
                        <ol>
                            <li><h2 class="hLh30 line3 pb10"><strong class="c-333 fsize20"><tt>订单号:</tt><font class="ml5 mr5 c-orange" id="orderId_success"></font>下单成功，订单总额<font class="ml5 c-orange" id="amount_success">￥${cashOrder.amount}</font></strong></h2></li>
                            <li class="mt10">
