	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
		...
		<tbody>
			<tr>
				...
				<td>
					<input type="text" name="userIntegralGift.name" class="{required:true}" id="giftName" value="${userIntegralGift.name}"/>&nbsp;&nbsp;<a class="am-btn am-btn-danger" title="提 交" href="javascript:addCourse()"  id="addCourse">添加课程</a>
				</td>
			</tr>
			<tr>
