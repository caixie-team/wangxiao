...
<body>
		<form action="${ctx}/admin/task/getTaskRecordList" name="searchForm" id="searchForm" method="post">
					...
					<div class="commonWrap">
						<table cellspacing="0" cellpadding="0" border="0" width="100%" class="commonTab01">
							...
							<tbody id="tabS_02" align="center">
								<c:if test="${taskRecordList.size()>0}">
									<c:forEach items="${taskRecordList}" var="taskRecordList">
									<tr>
										<td>
