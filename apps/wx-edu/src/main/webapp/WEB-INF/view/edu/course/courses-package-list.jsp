...
<body>
<form id="searchForm" action="${ctx}/front/showPackageList" method="post">
...
<div class="bg-fa of" id="aCoursesList">
	...
	<section class="container">
		<header class="comm-title course-com-title">
			<h2 class="fl tac"><span class="c-333">全部套餐</span></h2>
		...
		<section class="c-sort-box">
			...
			<c:if test="${not empty courseList}">
				<article class="cou-pack-list mt30">
					<ul class="of">
						<c:forEach items="${courseList }" var="course">
							<li class="pack-li">
								<div class="c-pk-wrap">
									<section class="course-img pr">
										...
										<div class="pa c-cou-title">
											<h3 class="txtOf">
												<a href="javascript:void(0)" class="course-title fsize20 c-fff">${course.name}</a>
											</h3>
										</div>
										<div class="cc-mask">
											<a href="${ctx}/front/couinfo/${course.id}" target="_blank" class="comm-btn c-btn-1">查看套餐</a>
										</div>
									</section>
									<section class="of c-p-info">
										<div class="c-ctitle ">
											<h5>
												<p class="c-666 txtOf f-fM">${course.title}<p>
											</h5>
										</div>
										<div class="cou-viewinfo">
											<ol class="of">
												<li style="border-left:none;"><em class="icon18 course-icon vam"></em><tt class="fsize14 c-666 vam">${course.lessionnum}个课程</tt></li>
												<li><em class="icon18 teacher-icon vam"></em><tt class="fsize14 c-666 vam">${course.teacherList==null?0:course.teacherList.size()}名讲师</tt></li>
												<li style="border-right:none;"><em class="icon18 student-icon vam"></em><tt class="fsize14 c-666 vam">${course.buycount}位学员</tt></li>
											</ol>
											<div class="clear"></div>
										</div>
									</section>
