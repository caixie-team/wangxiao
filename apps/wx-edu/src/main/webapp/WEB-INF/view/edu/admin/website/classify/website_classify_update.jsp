...
function submit(){
	...
	if(name.trim()==""){
		dialogFun("修改分类","关键词不能为空",0);
		return;
	}
	if(explain.trim()==""){
		dialogFun("修改分类","请输入说明",0);
		return;
	}
	var type=$("#type").val();
	 var judge=confirm("确定修改吗？");
	 if(judge==true){
		 $.ajax({
				url:"${ctx}/admin/websiteClassify/update",
				data:{"websiteClassify.id":'${websiteClassify.id}',"websiteClassify.name":name,"websiteClassify.explain":explain,"websiteClassify.type":type},
				dataType:"json",
				type:"post",
				cache:true,
				async:false,
...
<div class="am-cf">
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">分类管理</strong> / <small>修改分类</small></div>
</div>
<hr>
...
<div class="mt20">
	<div  class="am-tabs">
		<ul class="am-tabs-nav am-nav am-nav-tabs">
			<li class="am-active"><a href="javascript:void(0)">修改分类</a></li>
		</ul>
				...
				<form class="am-form"  method="post">
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input type="text" value="${websiteClassify.name}" class="am-input-sm" required placeholder="请填写关键词" name="websiteClassify.name" id="name">
						</div>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input value="${websiteClassify.explain}" type="text" class="am-input-sm" required placeholder="请填写说明" name="websiteClassify.explain" id="explain">
						</div>
					...
					<div class="am-g am-margin-top" am-form-group>
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" name="websiteClassify.sort" required id="sort" class="am-input-sm" value="${websiteClassify.sort }" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
						</div>
