...
<body>
	<div class="am-cf">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">微信管理</strong> / <small>新建多图文素材</small></div>
	</div>
	<hr/>
	<div class="mt20">
		<div class="am-tabs">
					...
					<form class="am-form" action="${ctx}/admin/weixin/add" method="post" id="addForm">
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								<input type="text" name="weixinReply.keyword" id="keyword" class="am-input-sm"/>
							</div>
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-4">
								<input type="text" name="weixinReply.title"  id="title" class="am-input-sm"/>
							</div>
							<div class="am-hide-sm-only am-u-md-2 am-text-danger">*必填</div>
						</div>
						<div class="am-g am-margin-top">
						...
						<div class="am-g am-margin-top">
							...
							<div class="am-u-sm-8 am-u-md-8">
								<div id="uchtml"></div>
								<a href="javascript:addImage()" title="添加图文工" class="am-btn am-btn-primary">添加图文</a>
