	...
	<div class="am-tabs">
		...
		<div class="am-tabs-bd">
			<div id="tab1" class="am-tab-panel am-fade am-active am-in am-scrollable-vertical">
				<form class="am-form" data-am-validator action="${ctx}/admin/func/addFunction" name="addForm" id="addForm" method="post" >
						...
						<div class="am-u-sm-8 am-u-md-6 am-form-horizontal">
							<div id="doc-dropdown-justify-js" style="width: 200px">
								<div class="am-dropdown" id="doc-dropdown-js">
									<input type="text" class="am-input-sm am-dropdown-toggle" id="parentName" placeholder="根目录" required name="pName" value="根目录" readonly="readonly"/>
					...
					<div class="am-g am-margin-top am-form-group">
						...
						<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
							<input type="text" class="am-input-sm" name="function.functionName" id="functionName">
						</div>
					</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" class="am-input-sm" name="function.functionUrl" id="functionUrl" />
						</div>
					...
					<div class="am-g am-margin-top" am-form-group>
						...
						<div class="am-u-sm-8 am-u-md-4">
							<input type="text" name="function.sort" required id="sort" class="am-input-sm" value="0" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
						</div>
