...
<body>
	...
	<div class="am-cf">
		<div class="am-fl am-cf">
			<strong class="am-text-primary am-text-lg">部门管理</strong> / <small>新建部门</small>
		</div>
	</div>
	<div class="mt20">
	<form action="${ctx}/admin/group/addGroup" name="addForm" id="addForm" class="am-form" method="post">
	<input type="hidden" name="group.parentGroupId" id="parentGroupId" value="0" />
	<input type="hidden" name="group.level" id="group.level" value="1" />
		<div class="am-tabs">
			<ul class="am-tabs-nav am-nav am-nav-tabs">
				<li class="am-active"><a href="javascript:void(0)">新建部门</a></li>
			</ul>
					...
					<div class="am-u-sm-8 am-u-md-6">
							<div id="doc-dropdown-justify-js">
							  <div class="am-dropdown" id="doc-dropdown-js">
							    <input required data-foolish-msg="父级不能为空" type="text" placeholder="根目录" value="根目录" class="am-input-sm am-dropdown-toggle" id="group_pname" readonly="readonly"/>
