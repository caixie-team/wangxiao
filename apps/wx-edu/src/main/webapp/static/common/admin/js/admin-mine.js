	...
	function dialogFun(dTitle,dTxt,num,url,userId) {
	    ...
	    init.prototype = {
	        ...
	        start : function() {
	            ...
	            _this.dCommEle = $('<div id="dialog-shadow" class="dialog-shadow"><div class="dContent"><header id="dHead" class="dHead"><span class="c-333 ml20">'+_this.dTitle+'</span></header><a href="javascript:void(0)" title="关闭" class="am-close dClose">&times;</a><div id="dcWrap" class="dcWrap">内容区域</div></div></div>').appendTo($("body")).addClass("bounceIn");
	            _this.dContArr = [
	                    ...
	                    '<div class="mt20 mb10"><a href="'+url+'" title="" class="am-btn am-btn-danger"><span>确 定</span></a><a href="javascript:void(0)" class="am-btn am-btn-default ml10 dCancel"><span>取 消</span></a></div></section>',
	                    
	                    '<section class="dca dca3">'+
	                    '<section><h6><span class="fsize12 c-666">收信人：</span><span class="fsize12 c-666">'+userName+'</span></h6></section>'+
	                    '<section class="mt10 am-form"><textarea name="" id="msgContent" class="dTextarea"></textarea></section>'+
