...
public class FavoritesTag extends WeiboResponse implements java.io.Serializable {
	...
	public static List<weibo4j.model.FavoritesTag> constructTags(Response res) throws WeiboException {
		try {
			JSONArray list = res.asJSONArray();
			int size = list.length();
			List<weibo4j.model.FavoritesTag> tags = new ArrayList<weibo4j.model.FavoritesTag>(size);
	...
	public static List<weibo4j.model.FavoritesTag> constructTag(Response res) throws WeiboException {
		try {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		weibo4j.model.FavoritesTag other = (weibo4j.model.FavoritesTag) obj;
		if (id == null) {
			if (other.id != null)
				return false;
