...
public class StatusWapper {
	...
	private List<weibo4j.model.Status> statuses;
	...
	public StatusWapper(List<weibo4j.model.Status> statuses, long previousCursor,
	...
	public List<weibo4j.model.Status> getStatuses() {
		return statuses;
	}
