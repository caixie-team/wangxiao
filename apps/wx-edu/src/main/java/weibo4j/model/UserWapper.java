...
public class UserWapper implements Serializable {
	 ...
	 * 用户对象列表
	 */
	private List<weibo4j.model.User> users;
	...
	public UserWapper(List<weibo4j.model.User> users, long previousCursor, long nextCursor, long totalNumber,String hasvisible) {
		this.users = users;
	...
	public List<weibo4j.model.User> getUsers() {
		return users;
	}
