...
public class MemConstans {
    ...
    public static final String MEM_ALL_COURSE = MEMFIX + "MEM_ALL_COURSE_";//课程目录树
    public static final int MEM_ALL_COURSE_TIME = Integer.parseInt(webPropertyUtil.getProperty("MEM_ALL_COURSE_TIME"));// 缓存一小时
    // 考试exam end
    ...
    public static final String INDEX_SUBJECT = MEMFIX + "index_subject";// 首页项目显示
    public static final int INDEX_SUBJECT_TIME = Integer.parseInt(webPropertyUtil.getProperty("INDEX_SUBJECT"));//缓存6小时
    ...
    public static final String HOME_INDEX_NEWS = MEMFIX + "home_index_news";//首页动态
    public static final int HOME_INDEX_NEWS_TIME = Integer.parseInt(webPropertyUtil.getProperty("HOME_INDEX_NEWS_TIME"));//缓存一小时
    ...
    public static final int USER_AUTO_TIME = Integer.parseInt(webPropertyUtil.getProperty("USER_AUTO_TIME"));//用户登录保存时间缓存7天
    ...
    public static final String SHOPCART_EHCACHE = MEMFIX + "eshopcats";//购物车

    public static final String USER_CANLOOK_GROUP = MEMFIX + "user_canlook_group";//用户是否可观看某个课程+courseId
    public static final int USER_CANLOOK_GROUP_TIME = Integer.parseInt(webPropertyUtil.getProperty("USER_CANLOOK_TIME"));//缓存6小时
    ...
    public static final String COURSE_SAME_SUBJECT = MEMFIX + "course_same_subject";//个人中心免费课程列表
    public static final int COURSE_SAME_SUBJECT_TIME = Integer.parseInt(webPropertyUtil.getProperty("COURSE_SAME_SUBJECT_TIME"));//缓存1小时;
    ...
    public static final String COURSE_PLAY_COUNT = MEMFIX + "course_play_count";//课程播放统计
    public static final String COURSE_PLAY_COUNT_THIRTY = MEMFIX + "course_play_count_thirty";//课程播放统计最近30条记录
    public static final int COURSE_PLAY_COUNT_TIME = Integer.parseInt(webPropertyUtil.getProperty("COURSE_PLAY_COUNT_TIME"));//缓存1小时;
    ...
    public static final String REGISTER_NUM = MEMFIX + "register_num";//注册人数
    public static final String REGISTER_SEND_MOBILE_CODE_NUM = MEMFIX + "register_send_mobile_code_num";//手机注册发送验证码次数
    public static final String REGISTER_PHONE_CODE = MEMFIX + "register_phone_code";//注册手机验证码
    public static final int REGISTER_PHONE_CODE_TIME = Integer.parseInt(webPropertyUtil.getProperty("REGISTER_PHONE_CODE_TIME"));//缓存5分钟;


    public static final String REGISTER_EMAIL_CODE = MEMFIX + "EMAIL_RANDOMCODE_USER";//邮箱登录验证码
    public static final int REGISTER_EMAIL_CODE_TIME = Integer.parseInt(webPropertyUtil.getProperty("REGISTER_EMAIL_CODE_TIME"));//缓存
