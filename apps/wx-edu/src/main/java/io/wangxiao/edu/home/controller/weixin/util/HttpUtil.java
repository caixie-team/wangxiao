package io.wangxiao.edu.home.controller.weixin.util;
...
public class HttpUtil {
    ...
    public static Map<String, Object> doGet(String urlStr, String param) {
        try {
            ...
            return gson.fromJson(tmpStr, new TypeToken<Map<String, Object>>() {
            }.getType());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static Map<String, Object> doPostJson(String url, Map<String, Object> map) {
        ...
        return gson.fromJson(result.toString(), new TypeToken<Map<String, Object>>() {
        }.getType());
    }
