...
public interface WeixinSetService {
     ...
     * @return
     */
    WeixinSetReply getWeixinSetReply(String type);
     ...
     */
    void addSetWeixinReply(WeixinSetReply weixinSetReply);
     ...
     * @param weixinSetReply
     */
    void updateSetWeixinReply(WeixinSetReply weixinSetReply);
     ...
     * @param id
     */
    void delWeixinSetReply(Long id);
