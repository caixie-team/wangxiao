package io.wangxiao.edu.common.util.kq;
...
public class KQHexUtil {
    ...
    public static String toHexString(byte[] b) {
        ...
        for (int i = 0; i < b.length; i++) {
            sb.append(io.wangxiao.edu.common.util.kq.KQHexUtil.HEX_CHARS.charAt(b[i] >>> 4 & 0x0F));
            sb.append(io.wangxiao.edu.common.util.kq.KQHexUtil.HEX_CHARS.charAt(b[i] & 0x0F));
        }
        return sb.toString();
    }
