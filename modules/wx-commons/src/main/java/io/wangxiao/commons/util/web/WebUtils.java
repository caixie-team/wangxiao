...
import io.wangxiao.commons.util.DESCoder;
...
/**
 * @ClassName com.business.platform.core.util.WebUtils
...
public class WebUtils {
     ...
     *
     * @param response   回应
     * @param nameValues Hashtable<String, String> 存入cookie的键值对
