...
import io.wangxiao.core.exception.StaleObjectStateException;
import io.wangxiao.course.entity.Course;
import io.wangxiao.order.entity.QueryTrxorder;
import io.wangxiao.order.entity.TrxOrderDTO;
import io.wangxiao.order.entity.TrxReqData;
import io.wangxiao.order.entity.Trxorder;
...
public interface TrxorderService {
     ...
     * @return id
     */
    Long mobileAddTrxorder(Trxorder trxorder);
