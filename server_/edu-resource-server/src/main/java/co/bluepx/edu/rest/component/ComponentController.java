...
public class ComponentController {
    ...
    @ApiOperation(value = "专业列表,用于根据专业ID查询的场景",  response = Subject.class)
    @RequestMapping(value = "/subject-tree", method = RequestMethod.GET)
    public ResponseEntity subjectTree(){

        return new ResponseEntity(subjectService.findSubjectTree(), HttpStatus.OK);
    }
}
