...
/* 微信消息加密 */
update edu_website_profile set desciption='{"wxAppID":"wx3aeac8262ed1","wxToken":"dfds","wxAppSecret":"b2fc6a2dd00ad5f1eb142928","encodingAESKey":"GLybO3moaatyWTyeNIFTkhhkP2XsOo"}' where type='weixin';
/* 微信常规回复修改关键字*/
