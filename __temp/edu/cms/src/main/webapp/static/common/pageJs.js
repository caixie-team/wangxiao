	...
	function ePosition() {
		//课程排列+排行SORT
		$(".courses-list-1>li:nth-child(3n),.s-c-list>li:nth-child(4n)").css({"margin-right" : "0px"});
	...
	function effect() {
		...
		$(".c-share").hover(function() {
			...
			$(this).stop().animate({"width" : "88px"}, 200);
	...
	function cousesMy() {
		document.onclick = function(e) {
			$(".my-course-wrap").removeClass("my-c-show");
		};
		$(".my-course-wrap>a.aMyCour").click(function(e) {
			if ($(".m-c-box").is(":hidden")) {
				$(this).parent(".my-course-wrap").addClass("my-c-show");
				...
				$(this).parent(".my-course-wrap").removeClass("my-c-show");
			};
			stopFunc(e);
		});
		$(".m-c-box").click(function(e) {
			stopFunc(e);
		});
	}
	//事件监听
	...
	function dialog(dTitle,conent,idnex,url,loginType) {
		var oBg = $('<div class="bg-shadow"></div>').appendTo($("body")),
			dialogEle = $('<div class="dialog-shadow"><div class="dialog-ele"><h4 class="d-s-head pr"><a href="javascript:void(0)" title="关闭" class="dClose icon16 pa">&nbsp;</a><span class="d-s-head-txt">'+dTitle+'</span></h4><div id="dcWrap" class="pt20 pb20 pl20 pr20 of" style=""></div></div></div>').appendTo($("body"));
			$.ajax({
