	...
	<div class="m-ptb54">
		...
		<div>
			...
			<section class="animated fadeIn">
					...
					<div class="v-card-title-box">
						<div class="v-card-title" style="position: absolute;">
							<ul class="col-2" id="item-l-ul">
								<li><a href="/mobile/uc/order/course" title="">录播课程订单</a></li>
								<li class="current"><a href="javascript: void(0)" title="">直播课程订单</a></li>
							</ul>
						</div>
					</div>
				</div>
									...
									<tbody>
										...
										<tr>
											<td align="left">
												<div>
													<span class="u-o-c-p">
														<img  src="<%=staticImageServer%>${detail.courseMobileImgUrl}" width="80" alt="">
													</span>
				...
				<form action="/mobile/uc/order/live" id="courseForm" method="post">
