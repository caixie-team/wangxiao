...
function dTree(objName, iPath, formId) {
	...
	this.icon = {
		...
		root : iPath + '/static/admin/images/dtree/base.gif',

		folder : iPath + '/static/admin/images/dtree/folder.gif',

		folderOpen : iPath + '/static/admin/images/dtree/folderopen.gif',

		node : iPath + '/static/admin/images/dtree/page.gif',

		empty : iPath + '/static/admin/images/dtree/empty.gif',

		line : iPath + '/static/admin/images/dtree/line.gif',

		join : iPath + '/static/admin/images/dtree/join.gif',

		joinBottom : iPath + '/static/admin/images/dtree/joinbottom.gif',

		plus : iPath + '/static/admin/images/dtree/plus.gif',

		plusBottom : iPath + '/static/admin/images/dtree/plusbottom.gif',

		minus : iPath + '/static/admin/images/dtree/minus.gif',

		minusBottom : iPath + '/static/admin/images/dtree/minusbottom.gif',

		nlPlus : iPath + '/static/admin/images/dtree/nolines_plus.gif',

		nlMinus : iPath + '/static/admin/images/dtree/nolines_minus.gif'
