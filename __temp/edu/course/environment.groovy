...
def $memcached = 'ihoubo.cn'
def $option = [
        domain   : '.' + $domain,
        memcached: '.' + $memcached + ":11211",
        db_driver: 'com.mysql.jdb.Driver',
        db_url   : 'jdbc:mysql://rdsqbjjbe2evein.mysql.rds.aliyuncs.com:3306/edu?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull',
        db_user  : 'grow',
        db_pwd   : 'Grow2015',
        //db_url   : 'jdbc:mysql://mysql:3306/edu?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull',
        //db_user  : 'admin',
        //db_pwd   : 'abcd1234',
        context  : 'http://' + $domain,
...
environments {
    dev {
        ...
        project {
            contextPath = $option.context
            examPath = $option.exam
            snsPath = $option.sns
            //图片、CSS、JS等静态资源文件地址
            staticServer = $option.context
            //静态资源上传服务地址
