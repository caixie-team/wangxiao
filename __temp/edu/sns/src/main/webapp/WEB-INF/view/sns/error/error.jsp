...
<%@page import="com.atdld.os.core.util.ObjectUtils"%>
...
<title>系统异常</title>
	<style type="text/css">
		* {margin: 0;padding: 0;}
		...
		.e-4-wrap {background: #3b3b3b url(${ctximg}/static/sns/images/err-404.jpg) no-repeat 0 0;margin: 5% auto 0;width: 640px;overflow: hidden;}
		...
		<div class="fl-2">
			<div class="e-4-txt-wrap">
				...
				<div>
					...
					<p class="e-4-t-1">3、或回到 <a href="/" title="首页">网站首页</a></p>
