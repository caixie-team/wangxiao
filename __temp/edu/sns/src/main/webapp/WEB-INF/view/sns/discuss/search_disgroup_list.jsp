				...
				<section class="W-main-c fl">
					<div class="W-main-cc">
						<section class="W-main-center">
							<div class="pl20">
								<section class="mt10">
									<header class="comm-title-1">
										<a href="#" class="fr c-888 mt10 mr10">创建小组&gt;&gt;</a>
										<ul class="clearfix">
											<li class="current">
												<a href="javascript:void(0)" title="小组列表">小组列表</a>
								...
								<div class="Prompt">
									...
									<p class="vam c-555 fsize14 disIb">没有符合条件的小组...</p>
								</div>
								</c:if>
								<section class="mt20">
									<ul class="qun-list">
											...
											<section class="clearfix">
												...
												<div class="fl qun-info-wrap">
													<section class="qun-ann-btn">
														...
														<p class="mt10"><a class="add-qun c-red" title="" href=""><i class="icon16 mr5">&nbsp;</i>加入该小组</a></p>
													</section>
													...
													<dl class="qun-info-txt">
														...
														<dd><span class="c-blue fsize14">${dis.cusId}</span></dd>
													</dl>
												</div>
											</section>
										</li>
							...
							<!-- 公共分页 结束 -->
							<form action="${ctx}/dis" name="searchForm" id="searchForm" method="post">
								...
								<div>
									...
									<section class="mt20 pr10">
										...
										<c:forEach items="${disGroupClassify }" var="disclassify">
											<li><a href="" title="" class="fsize14 c-orange">${disclassify.name }</a><span class="c-green">（${disclassify.groupNum }）</span></li>
											</c:forEach>
										</ul>
									</section>
								</div>
