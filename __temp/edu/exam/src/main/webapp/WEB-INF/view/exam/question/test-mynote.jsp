...
<body>
<form action="${ctx}/quest/toNoteQuestionList" name="searchForm" id="searchForm" method="post">
								...
								<section class="t-paper b-fff">
									<div class="my-history-title pl50">
										<ul>
											...
											<li class="current"><a href="${ctx}/quest/toNoteQuestionList" title="">习题笔记</a></li>
											...
											<ol class="m-h-lx">
												...
												<c:choose>
					                               <c:when test="${queryQuestionList!=null && queryQuestionList.size()>0 }">
														...
														<b class="c-666 fsize14">共有${page.totalResultSize}条笔记</b>
														</p>
														<c:forEach items="${queryQuestionList }" var="question">
															...
															<input type="hidden" class="questionIds" id="${id }"/>
																...
																<p class="c-999 mt5">练习时间: <fmt:formatDate value="${question.addTime }" pattern="yyyy-MM-dd HH:mm:ss"/> <span class="m-h-c-right c-999"> 
					                              ...
					                              <c:otherwise>
					                              		<section class="tac pt30 pb50">
															<span> <em class="k-tips-1 icon24"> </em> <font
																class="c-999 fsize14 ml10">你还没有记过笔记，在查看试题解析时能记录笔记</font>
															</span>
														</section>
					                              </c:otherwise>
					                            </c:choose>
