...
<body>
	...
	<div class="page_head">
		<h4><em class="icon14 i_01"></em>&nbsp;<span>考试专业管理</span> &gt; <span>考试科目添加</span> </h4>
	</div>
	<!-- /tab4 begin -->
	<div class="mt20">
		<form action="${ctx}/admin/professional/addExamSubejct" method="post" id="addForm">
			<input type="hidden" name="examSubject.professionalId" value="${professionalId}" />
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
			...
			<tbody>
				<tr>
					...
					<td>
						<input id="subjectName" type="text" name="examSubject.subjectName" maxlength="9" class="{required:true,number:true}"/>
				...
				<tr>
					...
					<td>
						<input id="sort" type="text" name="examSubject.sort" value="0" class="{required:true,number:true}"/>
