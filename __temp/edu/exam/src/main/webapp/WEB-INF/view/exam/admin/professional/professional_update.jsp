...
<body>
	...
	<div class="page_head">
		<h4><em class="icon14 i_01"></em>&nbsp;<span>考试专业科目管理</span> &gt; <span>考试专业修改</span> </h4>
	</div>
	<!-- /tab4 begin -->
	<div class="mt20">
		<form action="${ctx}/admin/professional/updateProfessional" method="post" id="addForm">
			<input type="hidden" name="professional.professionalId" value="${examProfessional.professionalId}" />
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
			...
			<tbody>
				<tr>
					...
					<td>
						<input id="professionalName" value="${examProfessional.professionalName}" type="text" name="professional.professionalName" maxlength="9" class="{required:true,number:true}"/>
				...
				<tr>
					...
					<td>
						<input id="sort" type="text" name="professional.sort" value="${examProfessional.sort}" class="{required:true,number:true}"/>
