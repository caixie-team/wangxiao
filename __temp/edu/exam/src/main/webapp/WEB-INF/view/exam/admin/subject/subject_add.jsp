...
<div class="page_head">
	<h4><em class="icon14 i_01"></em>&nbsp;<span>项目管理</span> &gt; <span>添加项目</span> </h4>
</div>
<div class="mt20">
...
<input type="hidden" name="subject.parentId" id="subjectpid" value="0" />
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
		<thead>
			<tr>
				<th colspan="2" align="left"><span>添加项目<tt class="c_666 ml20 fsize12"> <font color="red">(树级结构最多支持二级)</font> </tt></span></th>
			</tr>
		</thead>
		<tbody>
