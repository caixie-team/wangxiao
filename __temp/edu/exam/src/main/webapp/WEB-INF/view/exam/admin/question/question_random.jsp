...
<body >
					...
					<div class="capHead">
						<div class="clearfix">
							<div class="optionList">
								...
								<font>考试项目分类：</font>
								<input type="text"  id="subjectName" value="" readonly="readonly" onclick="subject_showZtree()"/>
								<div id="subject_distree"  style="display: none">
									<a class="btn smallbtn btn-y" onclick="subject_closetree()">关闭</a>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0"
			...
			<thead>
				<tr>
					<th colspan="2" align="left"><span>考点树<font color="red">(*树级结构最多支持三级)</font></span></th>
				</tr>
			</thead>
			<tbody>
				<tr>
