...
function loadPoint(){
	...
	var point= queryPointById(pointId);
	if(point!=null){
		str += point.name;
		if(point.parentId!=0){
...
<body  >
<div class="page_head">
	<h4><em class="icon14 i_01"></em>&nbsp;<span>试题管理</span> &gt; <span>更新试题</span> </h4>
</div>
<div class="mt20">
<div class="commonWrap">
<form action="${ctx}/admin/quest/updateQuestion" method="post" id="addQuestionForm">
<input name="question.id" id="id" type="hidden" value="${question.id }"/>
<input name=""  id="pointId"type="hidden" value="${question.pointId }"/>
<input type="hidden" value="" name="asr"/>
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
	<thead>
		<tr>
			<th colspan="2" align="left"><span>更新试题<tt class="c_666 ml20 fsize12">（<font color="red">*</font>&nbsp;为必填项）</tt></span></th>
		</tr>
	</thead>
	<tbody>
		<tr>
		...
		<tr>
			...
			<td>
				<select name="question.level" id="level">
		...
		<tr>
			...
			<td>
				<textarea style="width:600px;height:150px;" id="qstAnalyze" name="question.qstAnalyze" id="qstAnalyze">${question.qstAnalyze}</textarea>
			</td>
		</tr>
		<tr>
