...
<body >
<form action="${ctx}/admin/paper/addExamPaper" method="post" id="addPaperForm">
<input name="paper.subjectId" id="subjectId" type="hidden"/>
<div class="page_head">
	<h4><em class="icon14 i_01"></em>&nbsp;<span>试卷管理</span> &gt; <span>试卷添加</span> </h4>
</div>
<!-- /tab4 begin -->
<div class="mt20">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
		<thead>
			<tr>
				<th align="left" colspan="2"><span>试卷基本属性<tt class="c_666 ml20 fsize12">（<font color="red">*</font>&nbsp;为必填项）</tt></span></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				...
				<td>
					<input type="text" name="paper.name" class="{required:true}"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea style="width: 38%;height: 48px;" name="paper.info" class="{required:true}"></textarea>
				</td>
			</tr>
			<tr>
				<td align="center"><font color="red">*</font>&nbsp;限制答题时间</td>
				<td>
					<input type="text"  name="paper.replyTime" class="{required:true,number:true,min:0,max:1000}"/>
				</td>
			</tr>
			<tr>
				<td align="center"><font color="red">*</font>&nbsp;试卷总分</td>
				<td>
					<input type="text"  name="paper.score" class="{required:true,number:true}"/>
				</td>
			</tr>
			<tr>
				<td align="center"><font color="red">*</font>&nbsp;试卷难度</td>
				<td>
					<select name="paper.level">
