...
<%@page import="com.atdld.os.exam.constants.ExamConstants"%>
<%@page import="com.atdld.os.common.constants.CommonConstants"%>
...
<%!//项目路径
	...
	*/
	...
	<c:set var="ctxweb" value="<%=CommonConstants.webPath%>"></c:set>
