...
public class MemConstans {
    ...
    public static final String MEM_ALL_PROFESSIONAL = MEMFIX +"MEM_ALL_PROFESSIONAL";// 所有专业信息
    public static final int  MEM_ALL_PROFESSIONAL_TIME = Integer.parseInt(webPropertyUtil.getProperty("MEM_ALL_PROFESSIONAL_TIME"));;// 所有专业信息时间
