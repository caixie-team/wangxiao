...
<div class="page_head">
	<h4><em class="icon14 i_01"></em>&nbsp;<span>礼品管理</span> &gt; <span>新建礼品</span> </h4>
</div>
<!-- /tab4 begin -->
<div class="mt20">
	<form action="${ctx}/admin/user/addgift" method="post" id="addArticleForm">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
		...
		<tbody>
			<tr>
				<td align="center"><font color="red">*</font>&nbsp;礼品类型</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" name="userIntegralGift.name" class="{required:true}" id="giftName"/>&nbsp;&nbsp;<a class="btn btn-danger" title="提 交" href="javascript:addCourse()" style="display: none;" id="addCourse">添加课程</a>
				</td>
			</tr>
			<tr>
				<td width="20%" align="center"><font color="red">*</font>使用积分</td>
				<td width="80%">
				<input type="text" name="userIntegralGift.score" class="{required:true,number:true,digits:true}" id="score"/>
				</td>
			</tr>
			...
			<tr class="courseGift">
				...
				<td>
				<img src="<%=imagesPath %>/static/edu/images/NotAvailable.png" alt="" id="subjcetpic" width="178px" height="133px"/>
