...
<body >
<form action="${ctx}/admin/article/add" method="post" id="addArticleForm">
<input type="hidden" name="article.picture" id="imagesUrl"  />
<div class="page_head">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
		...
		<tbody>
			...
			<tr>
				...
				<td width="80%">
				<input type="text" name="article.meta" class="{required:true}"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="80%">
				<input type="text" name="article.author" class="{required:true}"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="80%">
				<input type="text" name="article.clickTimes" class="{required:true,number:true}" value="0"/>
				</td>
			</tr>
			<tr>
