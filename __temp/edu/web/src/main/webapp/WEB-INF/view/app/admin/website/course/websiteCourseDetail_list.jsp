...
<!-- 内容 开始  -->
	...
	<div class="mt20">
		<div class="commonWrap">
			<form action="${ctx}/admin/appWebsite/websiteCourseDetailPage" name="searchForm" id="searchForm" method="post">
							...
							<div class="w50pre fl">
								<ul class="ddBar">
									<li>
										...
										<input type="text" name="appWebsiteCourseDetailDTO.courseName" id="appWebsiteCourseDetailName" value="${appWebsiteCourseDetailDTO.courseName}"/>
									</li>
									<li>
										<span class="ddTitle"><font>是否下架：</font></span>
										<select name="appWebsiteCourseDetailDTO.isavaliable" id="isavaliable">
							...
							<div class="w50pre fl">
								<ul class="ddBar">
									<li>
										...
										<select name="appWebsiteCourseDetailDTO.recommendId" id="recommemd">
											<option value="-1">--请选择--</option>
					...
					<c:if test="${appWebsiteCourseDetailDTOList.size()>0}">
						...
						<tr>
							...
							<td  class="c_666 czBtn" align="center">
								<a class="ml10 btn smallbtn btn-y" href="${cxt}/admin/appWebsite/doUpdateWebsiteCourseDetail/${appWebsiteCourseDetail.id}" >修改</a>
								<a class="ml10 btn smallbtn btn-y" href="javascript:del(${appWebsiteCourseDetail.id})" >删除</a>
							</td>
						</tr>
						</c:forEach>
					</c:if>
