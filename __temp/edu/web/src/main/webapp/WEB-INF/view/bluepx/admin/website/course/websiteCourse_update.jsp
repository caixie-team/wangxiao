		...
		<table width="100%" cellspacing="0" cellpupdateing="0" border="0" class="commonTab01">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="websiteCourse.name" value="${websiteCourse.name }" id="websiteCourseName" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;更多跳转</td>
					<td>
						<input type="text"  name="websiteCourse.link" value="${websiteCourse.link }" id="link" class="{required:true,number:true,min:0,max:1000}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;课程数量</td>
					<td>
						<input type="text" name="websiteCourse.courseNum" value="${websiteCourse.courseNum }" id="courseNum" value="0" class="{required:true}"/>
					</td>
				</tr>
				<tr>
