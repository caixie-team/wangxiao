...
<body>
	<div class="mb50">
		<section class="ml50 mr50" style="margin-right: 95px;">
			<div class="mt10 pr">
				<div class="pathwray">
					<ol class="clearfix c-master f-fM fsize14">
						<li><a href="/" title="首页" class="c-master">首页</a> &gt;</li>
						<li><a href="${ctx}/library/list" title="文库" class="c-master">文库</a> &gt;</li>
					...
					<article class="">
						<section class="pb20 line3">
							<h2 class="tac unFw">
								...
								<font class="fsize24 c-333 f-fM vam" style="font-size: 26px;">${library.name}</font>
							</h2>
							<div class="mt5 mb5 tac">
								<span title='上传时间' class="c-999 vam disIb"><em class="icon14 a-time">&nbsp;</em><fmt:formatDate value="${library.addTime}" type="both"/> </span>
								<span title="查看人数${library.browseNum}人" class="disIb c-999 vam ml20"><em class="icon14 a-read">&nbsp;</em>${library.browseNum}人</span>
							</div>
						</section>
						<div>
