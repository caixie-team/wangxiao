...
$().ready(function() {
	...
	//勾选课程所属会员
	<c:forEach items="${course.memberTypes}" var="memberType">
		$("input[value='"+'${memberType.id}'+"']").prop("checked","checked"); 
	</c:forEach>
});
...
<body >
		...
		<input type="hidden" value="${course.id}" name="course.id" />
			...
			<input name="course.logo" id="logo" type="hidden" value="${course.logo}"/>
			<input name="course.mobileLogo" id="mobile_logo" type="hidden" value="${course.mobileLogo}"/>
			<div class="page_head">
				<h4>
					<em class="icon14 i_01"></em> &nbsp; <span>课程管理</span> &gt; <span>修改课程</span>
				</h4>
			</div>
			<!-- /tab4 begin -->
			<div class="mt20">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="course.name" value="${course.name}" class="required" /></td>
						</tr>
						...
						<tr>
							...
							<td><select id="sellType" disabled="disabled" >
                        ...
                        <tr class="showLive">
                            ...
                            <td><input id="liveBeginTime" type="text" name="course.liveBeginTime" readonly="readonly" class="required " value="<fmt:formatDate  type='both' value='${course.liveBeginTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" /></td>
                        </tr>
                        <tr class="showLive">
                            <td width="20%" align="center"><font color="red">*</font> &nbsp;直播结束时间</td>
                            <td><input id="liveEndTime" type="text" name="course.liveEndTime" readonly="readonly" class="required " value="<fmt:formatDate  type='both' value='${course.liveEndTime}' pattern='yyyy-MM-dd HH:mm:ss'/>"  /></td>
                        </tr>
                        <tr class="showLive">
                            <td width="20%" align="center"><font color="red">*</font> &nbsp;直播编码</td>
                            <td><input id="freeurl" type="text" name="course.freeurl" class="" value="${course.freeurl}" /></td>
                        </tr>
						<tr>
						...
						<tr>
							...
							<td width="80%">
								...
								<input type="radio" value="1" name="course.isPay" <c:if test="${course.isPay>0 }">checked="checked"</c:if>/>收费
							</td>
						</tr>
						<tr>
							<td width="20%" align="center">课程原价格</td>
							<td width="80%"><input type="text" value="${course.sourceprice}" name="course.sourceprice" class="required number" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;课程销售价格</td>
							<td><input type="text" value="${course.currentprice}" name="course.currentprice" class="required number" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><textarea rows="2" cols="82" name="course.title" class="required " maxlength="200" >${course.title}</textarea></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;课程详情</td>
							<td><textarea id="context" rows="5" cols="70"  name="course.context" class="required " >${course.context}</textarea></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="file" id="fileupload" style="float: left" />
								<div id="fileQueue" style="margin-top: 30px; border: 0px;"></div> <span style="float: left;"> 
								<img src="<%=staticImageServer%>${course.logo}" alt="" width="400px" height="300px" style="padding-left: 80px" id="imgUrl" />
							</span></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font>&nbsp;课程图片(380*180)</td>
							<td><input type="file" id="mobile_fileupload" style="float: left" />
								<div id="mobile_fileQueue" style="margin-top: 30px; border: 0px;"></div> <span style="float: left;"> 
								<img src="<%=staticImageServer%>${course.mobileLogo}" alt="" width="380px" height="180px" style="padding-left: 80px" id="mobile_imgUrl" />
							</span></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;总课时</td>
							<td><input type="text" name="course.lessionnum" value="${course.lessionnum}" class="required number"  /></td>
						</tr>
						...
						<tr class="loseTimeShow">
							...
							<td><input type="text" name="course.loseTime" id="loseTime" class="required number" value="${course.loseTime}"/>天</td>
						</tr>
						<tr class="loseAbsTimeShow">
							<td align="center"><font color="red">*</font> &nbsp;到期时间</td>
							<td><input type="text" name="course.loseAbsTime" id="loseAbsTime" class="required " value="<fmt:formatDate pattern="yyyy-MM-dd" type="both" value="${course.loseAbsTime}"/>" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;初始化假的销售数量</td>
							<td><input type="text" name="course.pageBuycount" value="${course.pageBuycount}" class="required number" value="0" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;初始化假的浏览数量</td>
							<td><input type="text" name="course.pageViewcount" value="${course.pageViewcount}" class="required number" value="0" /></td>
						</tr>
						<%-- <tr>
							<td align="center">&nbsp;试听地址</td>
							<td><input type="text" name="course.freeurl" value="${course.freeurl}" /></td>
						</tr> --%>
						<tr>
							<td align="center" colspan="2"><a class="btn btn-danger" title="提 交" href="javascript:addPaperFormSubmit()">提 交</a> <a
