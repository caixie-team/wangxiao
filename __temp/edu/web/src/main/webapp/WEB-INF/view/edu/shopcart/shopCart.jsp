...
<head>
<title>支付课程</title>
<script type="text/javascript" src="${ctximg}/static/edu/js/front/shopcart/shopcart.js"></script>
			...
			<article class="mt30" id="order_init">
				...
				<div class="buySettle clearfix pt20 pb20 pl20 pr20 order-table">
					...
					<div class="buyCoupon">
						...
						<div class="buyCoupon_con buyCouponWrap mt5">
							<div class="hei28 mt10 mr10 mb10 ml10">
								...
								<a href="javascript:addcode('')" class="buyCoupon_add2 pageSub" id="tjcode" >添加</a>
					...
					<div class="buySubmitBox">
						<a href="javascript:order()"  class="btn-big btn-orange order-submit mt10" id="shopCartButton">提交订单</a>
					</div>
					</section>
				</div>
				<!--结算信息 end-------------------------------------------------->
