			...
			<article class="mt30" id="order_init">
				...
				<div class="buySettle clearfix pt20 pb20 pl20 pr20 order-table">
					...
					<div class="fsize18 mt10">
						...
						<strong class="c-orange ml5" id="payprice">￥${payCash }</strong>
					</div>
					<div class="buySubmitBox">
						<a href="javascript:void(0)" onclick="javascript:cashOrder()" class="btn-big btn-orange order-submit mt10">提交订单</a>
					</div>
					</section>
				</div>
				<!--结算信息 end-------------------------------------------------->
				 	...
				 	<section class="mt20 mr20 mb20 ml20">
						<div class="orderSuccess pr ml20"  >
							<ol>
								...
								<li class="mt20"><span class="c-333 fsize14">您现在可以：<a class="c-333 mr10" title="重新选择支付方式" href="" id="repayA"><u>重新选择支付方式</u></a> | <a class="c-4e ml10 mr10" title="进入学习中心" href="${ctx }/uc/home"><u>进入学习中心</u></a> | <a class="c-4e ml10" title="返回首页" href="${ctx }/"><u>返回首页</u></a></span></li>
                        	</ol>
