...
<body >
		<form action="${ctx}/admin/appTopic/update" method="post" id="addCourse">
			<div class="page_head"><input type="hidden" name="appTopic.imageUrl" id="imagesUrl"  />
				<h4>
					<em class="icon14 i_01"></em> &nbsp; <span>话题管理</span> &gt; <span>话题修改</span>
				</h4>
			</div>
			<!-- /tab4 begin -->
			<div class="mt20">
			<div class="commonWrap">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						<tr>
							<td align="center"> &nbsp;话题发布人</td>
							<td>${appTopic.userName } </td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;话题标题</td>
							<td>
								<input type="text" name="appTopic.topicTitle" class="{required:true}" value="${appTopic.topicTitle }"/>
							</td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;话题详情</td>
							<td>
							<textarea rows="5" cols="50" name="appTopic.topicContent" id="content" class="{maxlength:50}">${appTopic.topicContent } </textarea></td>
						</tr>
						<tr>
							<td align="center"> &nbsp;话题图片</td>
							<td>
								<img src=<c:if test="${appTopic.imageUrl==null||appTopic.imageUrl==''}">'<%=imagesPath %>/static/edu/images/NotAvailable.png'</c:if><c:if test="${appTopic.imageUrl!=null||appTopic.imageUrl!=''}">'<%=staticImageServer %>/${appTopic.imageUrl }'</c:if> alt="" id="subjcetpic" width="400px" height="300px"/>
								<span id="imgBtn"><input type="button" value="上传" id="fileuploadButton"/></span>
							</td>
						</tr>
						<tr>
							<td align="center"> &nbsp;话题发布时间</td>
							<td><fmt:formatDate type="both" value="${appTopic.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						</tr>
						<tr>
							<td align="center"> &nbsp;话题状态</td>
							<td>
						...
						<td align="center" colspan="2">
							...
							<a class="btn btn-danger" title="提 交" href="javascript:addCourseFormSubmit()">提 交</a> <a
