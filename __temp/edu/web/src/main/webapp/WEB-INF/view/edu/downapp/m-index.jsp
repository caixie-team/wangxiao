...
<body>
	...
	<article class="header">
		<h1 class="jt-logo">
			<img src="/static/edu/downapp/images/logo-big.png" height="48" title="268在线教育软件 - 在线教育整体解决方案提供商" />
		</h1>
	</article>
	<!-- /header end-->
	<section class="j-main">
		<div class="slogan-top">
			<table width="100%" border="0">
				<tbody>
					<tr>
						<td width="30%" align="right" valign="middle"><img src="/static/edu/downapp/images/logo-s.png" class="sLogan" width="100" height="104" alt="268在线教育软件 - 在线教育整体解决方案提供商"></td>
						<td width="70%" align="left" valign="middle"><h2>传播知识的力量<p>下载你的学习STYLE，从这里开始</p></h2></td>
					</tr>
				</tbody>
			</table>
		</div>
