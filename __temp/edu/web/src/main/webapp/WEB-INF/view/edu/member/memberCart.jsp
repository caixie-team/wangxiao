	...
	<div class="mb50">
		<section class="w1000">
			...
			<article class="mt30" id="order_init">
				<div class="order-step-bg-2 order-step" id="order_step_img"></div>
				<!--商品清单 start-->
				<section class="mt30 comm-shadow-2" id="sellHaedSecid" style="overflow: visible;">
					<div class="o-s-title of">
						<h4 class="fl unFw"><em class="vam icon24 mr5 o-s-icon-2">&nbsp;</em><font class="c-master vam fsize18 f-fM">购买会员</font></h4>
					</div>
					<div class="order-table pb20" id="shopingcart">
						 <table width="100%" cellspacing="0" cellpadding="0" border="0" >
							<thead>
								<tr>
									<th width="70%" align="center">选择会员</th>
							...
							<tbody >
								<tr>
									<td>
										...
										<div class="fl w50pre mt10">
											<span class="dis fl ml20">开通时长：</span>
											<div class="selectWrap fl">
												<em>▼</em>
									...
									<td align="center"><samp id="memPrice"></samp></td>
								</tr>
							</tbody>
						</table>
						<div class="buyCom_price c-666 tar mr20">
							<span class="fsize14 f-fM">您所选会员总价：<span class="fsize18 c-orange mr5" id="div_totalMoney"></span></span>
						</div>
					</div>
				</section>
				<!--商品清单 end-->
				...
				<div class="buySettle clearfix pt20 pb20 pl20 pr20 order-table">
					...
					<section class="fl">
					<div class="buyCoupon">
						<div class="buyCoupon_tit fo hand" id="couponBtn" onclick="couponBtnClick(this)"><em class="icon18 bcIcon"></em><tt class="c-666 vam ml5">使用优惠券抵消部分金额</tt></div>
						<div class="buyCoupon_con buyCouponWrap mt5">
							<div class="hei28 mt10 mr10 mb10 ml10">
								<label class='c-666'>请输入优惠券编码：</label>
								<input class="buyText01"  name="" class="couponTxt" type="text" id="couponCode" onkeyup="inputMemCode()" onclick="inputMemCode()" />
								<a href="javascript:addMemcode()" class="buyCoupon_add2 pageSub" id="tjcode">添加</a>
					...
					<span class="c-666">订单总价</span> <span class="c-orange ml5" id="oldmoney">￥0.00</span>&nbsp;-
					<span class="c-666">优惠金额</span> <span class="c-orange ml5" id="yhmoney">￥0.00</span>&nbsp;=
					<span class="c-orange ml5" id="paySumPrice">￥0.00</span>
					...
					<div class="fsize18 mt10">
						...
						<strong class="c-orange ml5" id="payprice">￥0.00</strong>
					</div>
					<div class="buySubmitBox">
						<a href="javascript:void(0)" onclick="javascript:memOrder()" class="btn-big btn-orange order-submit mt10">提交订单</a>
					</div>
					</section>
				</div>
				<!--结算信息 end-------------------------------------------------->
				 	...
				 	<section class="mt20 mr20 mb20 ml20">
						<div class="orderSuccess pr ml20"  >
							<ol>
								...
								<li class="mt20"><span class="c-333 fsize14">您现在可以： <a class="c-4e ml10 mr10" title="进入学习中心" href="${ctx }/uc/home"><u>进入学习中心</u></a> | <a class="c-4e ml10" title="返回首页" href="${ctx }/"><u>返回首页</u></a></span></li>
							</ol>
