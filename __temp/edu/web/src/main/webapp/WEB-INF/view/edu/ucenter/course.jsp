							...
							<div class="pl20">
								...
								<section class="mt5">
									<div class="clearfix">
										...
										<div class="fl ml5"><label class="ml20 vam disIb c-888 fsize12" style="margin-top: -10px;"><input type="checkbox" name="name" checked="checked" id="public"/>&nbsp;公开</label></div>
									</div>
								</section>
								<!-- 页面提示  -->
								...
								<section class="mt10 DT-wrap">
									...
									<div class="tab-nosep mt10">
										<ol class="clearfix">
											<li class="current"><a href="javascript:void(0)" onclick="Dynamic(this,1)" title="全部">全部</a></li>
							...
							<div class="pl20">
								<div>
									<section class="comm-title-2">
										<span class="c-t-2-l">最近访客(<a href="${ctx}/friend?falg=visitor"><tt class="fsize12 f-fM c-blue">${num }</tt></a>)</span>
									</section>
									<section class="visitor-list mt20">
										<ul class="clearfix">
											...
											<c:if test="${vlt.avatar!=null&&vlt.avatar!='' }">
												...
												<span class="c-888" title="${vlt.modelStr}"><fmt:formatDate pattern="MM月dd日"  value="${vlt.addTime }"></fmt:formatDate></span>
											</c:if>
											<c:if test="${vlt.avatar==null||vlt.avatar=='' }">
