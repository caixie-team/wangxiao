...
<body>
	<div class="page_head">
		<h4><em class="icon14 i_01"></em>&nbsp;<span>文库管理</span> &gt; <span>添加文库</span> </h4>
	</div>
	<!-- /tab4 begin -->
	<div class="mt20">
		<form action="${ctx}/admin/library/add" method="post" id="addForm">
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="library.name" id="libraryName" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;简介 </td>
					<td>
						<textarea rows="5" cols="70" name="library.intro" id="intro" maxlength="200" class="required "></textarea>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;浏览次数</td>
					<td>
						<input type="text" name="library.browseNum" id="browseNum" class="required number" value="0" />
					</td>
				</tr>
				<tr>
					...
					<td><input type="file" id="fileupload" style="float: left" />
						...
						<span style="float: left;"> 
							<img src="" alt="" width="300px" height="240px" style="display: none; padding-left: 80px" id="imgpic" />
						</span>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;PDF文件</td>
					<td>
                      <p>
                          <input type="text" style="width: 500px;" name="library.pdfUrl" id="urlStr"/>(可直接输入地址)
                        </p>
