			 	...
			 	<section class="mt20 mr20 mb20 ml20">
					<div class=" pr ml20">
						<ol>
							...
							<li class="mt20" style="text-align: center"><span class="c-333 fsize14">您现在可以：<a id="repaylink" class="c-333 mr10" title="返回修改支付方式" href="/front/repay/${orderId }"><u>返回修改支付方式</u></a> | <a class="c-4e ml10 mr10" title="进入学习中心" href="${ctx }/uc/home"><u>进入学习中心</u></a> | <a class="c-4e ml10" title="返回首页" href="${ctx }/"><u>返回首页</u></a></span></li>
							</c:if>
