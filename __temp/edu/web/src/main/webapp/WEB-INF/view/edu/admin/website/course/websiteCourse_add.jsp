...
<body>
	...
	<div class="page_head">
		<h4><em class="icon14 i_01"></em>&nbsp;<span>推荐课程分类管理</span> &gt; <span>新建推荐课程分类</span> </h4>
	</div>
	<!-- /tab4 begin -->
	<div class="mt20">
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="websiteCourse.name" id="websiteCourseName" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;更多跳转</td>
					<td>
						<input type="text"  name="websiteCourse.link" id="link" class="{required:true,number:true,min:0,max:1000}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;课程数量</td>
					<td>
						<input type="text" name="websiteCourse.courseNum" id="courseNum" value="0" class="{required:true}"/>
					</td>
				</tr>
				<tr>
