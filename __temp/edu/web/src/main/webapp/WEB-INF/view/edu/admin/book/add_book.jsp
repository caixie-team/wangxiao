			...
			<div class="commonWrap">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						...
						<td><input type="text" name="book.nowPrice"/></td>
						</tr>
						<tr>
						<td align="center"><font color="red">*</font> &nbsp;商品价格:折扣价</td>
						<td><input type="text" name="book.rebatePrice"/></td>
						</tr>
						<tr>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="book.author" maxlength="60"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;出版社 </td>
							<td><input type="text" name="book.press" id="press" maxlength="60"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;出版时间 </td>
							<td><input type="text" name="book.publishTime" id="publishTime" readonly="readonly"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;版次 </td>
							<td><input type="text" name="book.revision" id="revision" maxlength="60"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;印次 </td>
							<td><input type="text" name="book.printNum" id="printNum" maxlength="60"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;页数 </td>
							<td><input type="text" name="book.pageNum" id="pageNum"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;字数 </td>
							<td><input type="text" name="book.wordNum" id="wordNum"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;包装 </td>
							<td><input type="text" name="book.bookPackage" id="bookPackage" maxlength="60"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;纸张 </td>
							<td><input type="text" name="book.pager" id="pager" maxlength="60"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;重量 </td>
							<td><input type="text" name="book.weight" id="weight" class="number"/><select name="gram">
						...
						<tr>
							...
							<td><input type="text" name="book.isbn" id="isbn" class="number"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;开本 </td>
							<td><input type="text" name="book.bookSize" id="bookSize" value="16" maxlength="20"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;图书注释 </td>
							<td><input type="text" name="book.remarks" id="remarks"/></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;图书简介</td>
							<td><textarea id="bookInfo" rows="5" cols="70" name="book.bookInfo"></textarea></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;图书目录</td>
							<td><textarea id="bookContext" rows="5" cols="70" name="book.directory"></textarea></td>
						</tr>
					</tbody>
					</table>
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tr>
						...
						<tr>
							...
							<td><input type="text" name="book.payUrl" id="payUrl"/></td>
						</tr>
						<tr>
