...
<body >
		<form action="${ctx}/admin/book/update" method="post" id="addBook">
			<input type="hidden" name="book.bookId" id="bookId" value="${book.bookId}"/>
            ...
            <input type="hidden" name="book.status" id="bookstatus" value="${book.status}"/>
			<div class="page_head">
				<h4>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="book.bookName" class="required" value="${book.bookName}" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="book.price" class="required number"  value="${book.price}" /></td>
						</tr>
						<tr>
						<td align="center"><font color="red">*</font> &nbsp;商品价格:现价</td>
						<td><input type="text" name="book.nowPrice" class="required number"  value="${book.nowPrice}" /></td>
						</tr>
						<tr>
						<td align="center"><font color="red">*</font> &nbsp;商品价格:折扣价</td>
						<td><input type="text" name="book.rebatePrice" class="required number"  value="${book.rebatePrice}" /></td>
						</tr>
						<tr>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="book.author" class="required" maxlength="60" value="${book.author}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;出版社 </td>
							<td><input type="text" name="book.press" id="press" maxlength="60" value="${book.press}" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="book.revision" id="revision" maxlength="60" value="${book.revision}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;印次 </td>
							<td><input type="text" name="book.printNum" id="printNum" maxlength="60" class="required number" value="${book.printNum}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;页数 </td>
							<td><input type="text" name="book.pageNum" id="pageNum" class="required number" value="${book.pageNum }" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;字数 </td>
							<td><input type="text" name="book.wordNum" id="wordNum" class="required number" value="${book.wordNum}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;包装 </td>
							<td><input type="text" name="book.bookPackage" id="bookPackage" maxlength="60" value="${book.bookPackage}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;纸张 </td>
							<td><input type="text" name="book.pager" id="pager" maxlength="60" value="${book.pager}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;重量 </td>
							<td><input type="text" name="book.weight" id="weight" class="number" value="${book.weight}" /><select name="gram">
						...
						<tr>
							...
							<td><input type="text" name="book.isbn" id="isbn" class="number" value="${book.isbn}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;开本 </td>
							<td><input type="text" name="book.bookSize" id="bookSize" value="16" maxlength="20" class="number" value="${book.bookSize}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;图书注释 </td>
							<td><input type="text" name="book.remarks" id="remarks" class="required" value="${book.remarks}" /></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;图书简介</td>
							<td><textarea id="bookInfo" rows="5" cols="70" name="book.bookInfo" maxlength="200" class="required" >${book.bookInfo}</textarea></td>
						</tr>
						<tr>
							<td align="center"><font color="red">*</font> &nbsp;图书目录</td>
							<td><textarea id="bookContext" rows="5" cols="70" name="book.directory" class="required" >${book.directory}</textarea></td>
						</tr>
					</tbody>
					</table>
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					...
					<tr>
						...
						<tr>
							...
							<td><input type="text" name="book.payUrl" id="payUrl" value="${book.payUrl }" /></td>
						</tr>
						<tr>
