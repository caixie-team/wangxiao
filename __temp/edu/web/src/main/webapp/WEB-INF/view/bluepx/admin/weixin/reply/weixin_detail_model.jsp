...
<body id="activity-detail">
        ...
        <div class="page-bizinfo">
            <div class="header">
            <h1 id="activity-name">${weixinReply.title}</h1>
            <p class="activity-info">
                <span id="post-date" class="activity-meta no-extra"><fmt:formatDate value="${weixinReply.createTime}" pattern="yyyy-MM-dd"/> 
                </span>
                    <span style="color:#5f7fa6;font-size:11px">${weixinReply.nickName}</span>
                </a>
            </p>
            </div>
        </div>
        ...
        <div id="page-content" class="page-content">
            <div id="img-content">
                        ...
                        <div class="media" id="media"><img alt="" src="<%=staticImageServer%>${weixinReply.imageUrl}"></div>
                        <div class="text">
                        	${weixinReply.content}
                        </div>
