		...
		<section class="w1000">
			<div class="mt30 pr">
				<div class="pathwray">
					<ol class="clearfix c-master f-fM fsize14">
						...
						<li><span>课程中心</span></li>
					</ol>
				</div>
				<section class="c-search pa">
					<div class=" clearfix">
						<section class="fr s-inp-wrap">
							<form id="searchForm" action="${ctx}/front/showcoulist" method="post">
			...
			<div class="mt30">
				<section class="mb20">
                	   <div class="select">
                            ...
                            <div class="select-box3">
                                <div class="select-box2-left">
                                    <p class="btName">按会员:</p>
                                </div>
                                <div class="select-box2-right">
                                    <ul class="select-box2-mid">
                                    	<c:forEach items="${memberTypes }" var="memberType">
                                        <li><a onclick="clickSearch('memberType',${memberType.id})" title="${memberType.title }" href="javascript:void(0);"> ${ memberType.title} </a></li>
                                    	</c:forEach>
                                     </ul>
                                      <div class="select-box2-RT">
                                         <a class="select-unfolt suMore" href="javascript:void(0)">更多↓</a>
						...
						<section class="fl">
							<ul class="of sub-sort">
							 	...
							 	<li class="sub-s-wrap">
							 		...
							 		<a id="orderAid3" href="javascript:void(0)" onclick="orderByQuery(this,3)" title="价格">价格<em class="icon14 u-jg">&nbsp;</em></a>
							 	</li>
							 </ul>
						</section>
					</div>
			...
			<div class="mb50">
				...
				<section id="SL-container">
					<div class="mt40">
						<ol class="s-c-list">
							<c:forEach items="${courseList }" var="coursePage" varStatus="index">
							<li>
