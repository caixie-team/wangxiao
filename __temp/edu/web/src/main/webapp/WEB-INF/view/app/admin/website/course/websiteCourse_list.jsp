				...
				<table cellspacing="0" cellpadding="0" border="0" width="100%" class="commonTab01">
					<caption>
						<div style="margin-top: 10px;">
							<span>
								<input type="button" value="添加" class="btn btn-danger ml10" onclick="window.location.href='${cxt}/admin/appWebsite/doAddWebsiteCourse'"/>
							</span>
						</div>
					</caption>
					<thead>
					...
					<c:forEach  items="${websiteCourseList}" var="websiteCourse" >
						<tr>
							...
							<td  class="c_666 czBtn" align="center">
								<a class="ml10 btn smallbtn btn-y" href="${cxt}/admin/appWebsite/doUpdateWebsiteCourse/${websiteCourse.id}" >修改</a>
