...
<body  >
<form action="${ctx}/admin/answer/answerQuestionList" name="searchForm" id="searchForm" method="post">
...
<!-- 内容 开始  -->
<div class="page_head">
				<h4><em class="icon14 i_01"></em>&nbsp;<span>答疑管理</span> &gt; <span>题库答疑</span> </h4>
			</div>
			<!-- /tab1 begin-->
<div class="mt20">
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" class="commonTab01" >
			...
			<c:forEach  items="${answerQuestionList}" var="answer" >
				<tr id="answer${answer.id }">
					...
					<td id="sonName${answer.id }">${fn:substring(answer.sonName,0,15)}</td>
