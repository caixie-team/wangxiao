...
<body>
	<div class="page_head">
		<h4><em class="icon14 i_01"></em>&nbsp;<span>推荐课程分类管理</span> &gt; <span>推荐课程分类修改</span> </h4>
	</div>
	<!-- /tab4 begin -->
	<div class="mt20">
		<form action="${ctx}/admin/appWebsite/updateWebsiteCourse" method="post" id="updateWebsiteCourseForm">
		<input type="hidden" name="appWebsiteCourse.id" value="${appWebsiteCourse.id}"/>
		<table width="100%" cellspacing="0" cellpupdateing="0" border="0" class="commonTab01">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="appWebsiteCourse.name" value="${appWebsiteCourse.name }" id="appWebsiteCourseName" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;更多跳转</td>
					<td>
						<input type="text"  name="appWebsiteCourse.link" value="${appWebsiteCourse.link }" id="link" class="{required:true,number:true,min:0,max:1000}"/>
					</td>
				</tr>
				<tr>
					<td align="center"><font color="red">*</font>&nbsp;课程数量</td>
					<td>
						<input type="text" name="appWebsiteCourse.courseNum" value="${appWebsiteCourse.courseNum }" id="courseNum" value="0" class="{required:true}"/>
					</td>
				</tr>
				<tr>
					<td align="center">描述</td>
					<td>
						<textarea rows="3" cols="80" name="appWebsiteCourse.description" id="description">${appWebsiteCourse.description }</textarea>
					</td>
				</tr>
				<tr>
