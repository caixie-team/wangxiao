...
import co.bluepx.edu.course.dao.CourseDao;
...
public class CourseService extends BaseService<Course, CourseDao> {
     ...
     * @return
     */
    public List<CourseDto> findRecommendCourses(Long recommendId) {

        return baseDao.findRecommendCourses(recommendId);
    }
    ...
    public CourseDto findCourseDtoById(Long id) {
        ...
        try {
//            CourseDto dto =
            return baseDao.findCourseListByCourseIds(
                    new HashMap<String, Object>() {{
                        put("ids", Arrays.asList(id));
                    }}
            ).get(0);
     ...
     * @return List<Course>
     */
    public PageInfo<CourseDto> findCourseListByPage(QueryCourse query, int pageNum, int pageSize) {

        return PageHelper
                .startPage(pageNum, pageSize)
//                .setOrderBy("id desc")
                .doSelectPageInfo(() -> baseDao.findCourseListByPage(query));
    }
    ...
    public List<Course> findCourseByTeacherId(Long teacherId) {
        return baseDao.findCourseByTeacherId(teacherId);
    }
     ...
     * @return List<Course>
     */
    public List<CourseDto> findCourseListPackage(List<Long> ids) {
        return baseDao.findCourseListPackage(ids);
    }
     ...
     * @param　courseId　传此参数时，查询该课程相同专业下的课程
     * @param num　返回条数
     * @return List<Course>
     */
    public List<CourseDto> findSubjectCourseList(Long subjectId,Long courseId, int num) {
        Map<String, Object> map = new HashMap<>();
        map.put("subjectId", subjectId);
        map.put("courseId", courseId);
        map.put("num", num);

        return baseDao.findSubjectCourseList(map);
