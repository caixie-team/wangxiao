package co.bluepx.edu.common.constants;
...
public class MemConstans {
    ...
    public static final int USER_AUTO_TIME = Integer.parseInt(webPropertyUtil.getProperty("USER_AUTO_TIME"));//用户登录保存时间缓存30天
